...
(function(window, undefined) {
    ...
    DependencyGraph.prototype = {
        ...
        startListeningRange: function(sheetId, bbox, listener) {
            ...
            if (bbox.isOneCell()) {
                ...
                if (!areaSheetElem) {
                    ...
                    if (true) {
                        areaSheetElem.sharedBroadcast = {
                            changedBBox: null,
                            prevChangedBBox: null,
                            recursion: 0
                        };
                    }
        ...
        prepareChangeSheet: function(sheetId, data, tableNamesMap) {
            ...
            var notifyData = {
                type: c_oNotifyType.Prepare,
                actionType: c_oNotifyType.ChangeSheet,
                data: data,
                transformed: {},
                preparedData: {}
            };
            ...
            return {
                listeners: listeners,
                data: data,
                preparedData: notifyData.preparedData
            };
        },
        changeSheet: function(prepared) {
            var notifyData = {
                type: c_oNotifyType.ChangeSheet,
                data: prepared.data,
        ...
        prepareRemoveSheet: function(sheetId, tableNames) {
            ...
            //dependence
            return this.prepareChangeSheet(sheetId, {
                remove: sheetId,
        ...
        editDefinesNames: function(oldUndoName, newUndoName) {
            ...
            if (res && oldUndoName) {
                if (oldUndoName.name != newUndoName.name) {
                    ...
                    var notifyData = {
                        type: c_oNotifyType.ChangeDefName,
                        from: oldUndoName,
                        to: newUndoName
                    };
        ...
        delTableName: function(tableName, bConvertTableFormulaToRef) {
            ...
            var notifyData = {
                type: c_oNotifyType.ChangeDefName,
                from: defName.getUndoDefName(),
                to: null,
                bConvertTableFormulaToRef: bConvertTableFormulaToRef
            };
        ...
        delColumnTable: function(tableName, deleted) {
            this.buildDependency();
            var notifyData = {
                type: c_oNotifyType.DelColumnTable,
                tableName: tableName,
                deleted: deleted
            };
            this._broadcastDefName(tableName, notifyData);
        ...
        renameTableColumn: function(tableName) {
            ...
            if (defName) {
                this.buildDependency();
                var notifyData = {
                    type: c_oNotifyType.RenameTableColumn,
                    tableName: tableName
                };
                this._broadcastDefName(defName.name, notifyData);
            }
        ...
        _shiftMoveDelete: function(notifyType, sheetId, bbox, offset, sheetIdTo) {
            ...
            if (sheetContainer) {
                ...
                var notifyData = {
                    ...
                    bbox: bbox,
                    offset: offset,
                    shiftedShared: res.shiftedShared
                };
                for (var listenerId in listeners) {
                    listeners[listenerId].notify(notifyData);
                }
    ...
    Workbook.prototype._insertWorksheetFormula = function(index) {
        if (index > 0 && index < this.aWorksheets.length) {
            ...
            this.dependencyFormulas.changeSheet(this.dependencyFormulas.prepareChangeSheet(oWsBefore.getId(), {
                insert: index
            }));
        }
    };
    Workbook.prototype.replaceWorksheet = function(indexFrom, indexTo) {
        if (indexFrom >= 0 && indexFrom < this.aWorksheets.length &&
            ...
            if (tempW.wFI < tempW.wTI)
                tempW.wTI++;
            this.dependencyFormulas.lockRecal();
            var prepared = this.dependencyFormulas.prepareChangeSheet(oWsFrom.getId(), {
                replace: tempW
            }, null);
            //move sheets
        ...
        for (var i = 0, length = this.aWorksheets.length; i < length; ++i) {
            ...
            if (res !== null) {
                res = {
                    wsID: ws.getId(),
                    index: res,
                    name: ws.getTableNameColumnByIndex(tableName, res)
                };
                break;
            }
        }
    ...
    Workbook.prototype.findCellText = function(options) {
        ...
        if (!options.scanOnOnlySheet) {
            ...
            if (!key || (options.isEqual(this.lastFindOptions) && this.lastFindCells[key])) {
                ...
                var i, active = this.getActive(),
                    start = 0,
                    end = this.getWorksheetCount();
    ...
    Worksheet.prototype.setName = function(name, bFromUndoRedo) {
        if (name.length <= g_nSheetNameMaxLength) {
            ...
            History.Create_NewPoint();
            var prepared = this.workbook.dependencyFormulas.prepareChangeSheet(this.getId(), {
                rename: {
                    from: lastName,
                    to: name
                }
    ...
    Worksheet.prototype.removeRows = function(start, stop, bExcludeHiddenRows) {
        var removeRowsArr = bExcludeHiddenRows ? this._getNoHiddenRowsArr(start, stop) : [{
            start: start,
            stop: stop
        }];
    ...
    Worksheet.prototype._moveCells = function(oBBoxFrom, oBBoxTo, copyRange, wsTo, offset) {
        ...
        wsTo.getRange3(oBBoxTo.r1, oBBoxTo.c1, oBBoxTo.r2, oBBoxTo.c2)._foreachNoEmpty(function(cell) {
            ...
            if (formula) {
                ...
                var preMoveCell = {
                    nRow: cell.nRow - offset.row,
                    nCol: cell.nCol - offset.col
                };
                ...
                if (countC) {
                    for (j = 0; j < item.x.length; ++j) {
                        ...
                        if (field && null !== field.numFmtId) {
                            cells.setNum(new AscCommonExcel.Num({
                                id: field.numFmtId
                            }));
                        }
    ...
    Worksheet.prototype._findAllCells = function(options) {
        ...
        var result = new AscCommonExcel.findResults(),
            tmp;
    ...
    Cell.prototype.setNumFormat = function(val) {
        this.setNum(new AscCommonExcel.Num({
            f: val
        }));
    };
    ...
    Cell.prototype.setFontname = function(val) {
        ...
        this._setFontProp(function(format) {
            return val != format.getName();
        }, function(format) {
            format.setName(val);
        });
        if (History.Is_On() && oRes.oldVal != oRes.newVal)
    ...
    Cell.prototype.setUnderline = function(val) {
        ...
        this._setFontProp(function(format) {
            return val != format.getUnderline();
        }, function(format) {
    ...
    Cell.prototype.setStrikeout = function(val) {
        ...
        this._setFontProp(function(format) {
            return val != format.getStrikeout();
        }, function(format) {
    ...
    Cell.prototype.setFontAlign = function(val) {
        ...
        this._setFontProp(function(format) {
            return val != format.getVerticalAlign();
        }, function(format) {
    ...
    Cell.prototype.getValueForExample = function(numFormat, cultureInfo) {
        var aText = this._getValue2(AscCommon.gc_nMaxDigCountView, function() {
            return true;
        }, numFormat, cultureInfo);
    ...
    Cell.prototype.getValue = function() {
        this._checkDirty();
        var aTextValue2 = this.getValue2(AscCommon.gc_nMaxDigCountView, function() {
            return true;
        });
            ...
            if (valueCalc) {
                if (0 <= valueCalc.numFormat) {
                    if (aStandartNumFormatsId[t.getNumFormatStr()] == 0) {
                        t.setNum(new AscCommonExcel.Num({
                            id: valueCalc.numFormat
                        }));
                    }
    ...
    Range.prototype._foreach2 = function(action) {
        if (null != action) {
            ...
            wb.loadCells.push(tempCell);
            var oBBox = this.bbox,
                minC = Math.min(this.worksheet.getColDataLength(), oBBox.c2),
                minR = Math.min(this.worksheet.cellsByColRowsCount - 1, oBBox.r2);
    ...
    Range.prototype._foreachNoEmpty = function(actionCell, actionRow, excludeHiddenRows) {
        var oRes, i, oBBox = this.bbox,
            minR = Math.max(this.worksheet.cellsByColRowsCount - 1, this.worksheet.rowsData.getSize() - 1);
    ...
    Range.prototype._canShiftLeftRight = function(bLeft) {
        ...
        return {
            aColsToDelete: aColsToDelete,
            aCellsToDelete: aCellsToDelete
        };
    };
    ...
    Range.prototype._getSortElems = function(bbox, nStartRowCol, nOption, sortColor, opt_by_row, opt_custom_sort) {
                ...
                if ("" != val) {
                    ...
                    if (opt_by_row) {
                        res = {
                            ...
                            num: nNumber,
                            text: sText,
                            colorFill: colorFillCell,
                            colorsText: colorsTextCell
                        };
                    } else {
                        res = {
                            row: nRow0,
        ...
        return {
            aSortElems: aSortElems,
            nRowFirst0: nRowFirst0,
            nColFirst0: nColFirst0,
            nLastRow0: nLastRow0,
            nLastCol0: nLastCol0
        };
    };
    ...
    HiddenManager.prototype.getHiddenRowsRange = function() {
        ...
        if (this.hiddenRowMin <= this.hiddenRowMax) {
            res = {
                r1: this.hiddenRowMin,
                r2: this.hiddenRowMax
            };
            this.hiddenRowMin = gc_nMaxRow0;
            this.hiddenRowMax = 0;
        }
