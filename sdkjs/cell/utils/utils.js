...
(
    ...
    function(window, undefined) {
        ...
        function getMatchingBorder(border1, border2) {
            ...
            var r1 = border1.c.getR(),
                g1 = border1.c.getG(),
                b1 = border1.c.getB();
            var r2 = border2.c.getR(),
                g2 = border2.c.getG(),
                b2 = border2.c.getB();
        ...
        SelectionRange.prototype.setCell = function(r, c) {
            ...
            if (mc) {
                res = -1 === this.offsetCell(1, 0, false, function() {
                    return false;
                });
                if (res) {
        ...
        FormulaRange.prototype.getName = function() {
            var sRes = "";
            var c1Abs = this.isAbsCol(this.refType1),
                c2Abs = this.isAbsCol(this.refType2);
            var r1Abs = this.isAbsRow(this.refType1),
                r2Abs = this.isAbsRow(this.refType2);
        ...
        RangeCache.prototype._getRange = function(sRange, type) {
            ...
            if (null == oRes && null != oCacheVal.first && null != oCacheVal.last) {
                ...
                var r1Abs = oCacheVal.first.getRowAbs(),
                    r2Abs = oCacheVal.last.getRowAbs(),
                    c1Abs = oCacheVal.first.getColAbs(),
                    c2Abs = oCacheVal.last.getColAbs();
        ...
        function drawStyle(ctx, sr, oStyle, sStyleName, width, height) {
            var bc = null,
                bs = AscCommon.c_oAscBorderStyles.None,
                isNotFirst = false; // cached border color
            ctx.clear();
            // Fill cell
            if (oStyle.ApplyFill) {
        ...
        asc_CSelectionRangeValue.prototype.asc_setType = function(val) {
            this.type = val;
        };
        asc_CSelectionRangeValue.prototype.asc_setName = function(val) {
            this.name = val;
        };
        asc_CSelectionRangeValue.prototype.asc_getType = function() {
            return this.type;
        };
        asc_CSelectionRangeValue.prototype.asc_getName = function() {
            return this.name;
        };
