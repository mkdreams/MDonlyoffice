    ...
    function(window, undefined) {
        ...
        CChartsDrawer.prototype = {
            ...
            _calculateData2: function(chart, grouping, axis) {
                var xNumCache, yNumCache, newArr, arrValues = [],
                    max = 0,
                    min = 0,
                    minY = 0,
                    maxY = 0;
            ...
            _getYPositionLogBase: function(val, yPoints, isOx, logBase) {
                ...
                var parseVal, maxVal, minVal, startPos = 0,
                    diffPos;
                if (logVal < 0) {
        ...
        drawBarChart.prototype = {
            ...
            _recalculateBars: function( /*isSkip*/ ) {
                ...
                var height, startX, startY, val, paths, seriesHeight = [],
                    tempValues = [],
                    seria, startYColumnPosition, startXPosition, prevVal, idx, seriesCounter = 0;
                var cubeCount = 0;
            ...
            calculateParallalepiped: function(startX, startY, individualBarWidth, height, val, isValMoreZero, isValLessZero, i, idx, cubeCount, arr) {
                ...
                var x2 = startX,
                    y2 = startY,
                    z2 = perspectiveDepth + gapDepth;
                var x3 = startX + individualBarWidth,
                    y3 = startY,
                    z3 = perspectiveDepth + gapDepth;
                var x4 = startX + individualBarWidth,
                    y4 = startY,
                    z4 = 0 + gapDepth;
                var x5 = startX,
                    y5 = startY - height,
                ...
                var x6 = startX,
                    y6 = startY - height,
                    z6 = perspectiveDepth + gapDepth;
                var x7 = startX + individualBarWidth,
                    y7 = startY - height,
                    z7 = perspectiveDepth + gapDepth;
                var x8 = startX + individualBarWidth,
                    y8 = startY - height,
                    z8 = 0 + gapDepth;
                ...
                var arrPoints = [
                    [point1, point4, point8, point5],
                    [point1, point2, point3, point4],
                    [point1, point2, point6, point5],
                    [point4, point8, point7, point3],
                    [point5, point6, point7, point8],
                    [point6, point2, point3, point7]
                ];

                var arrPoints2 = [
                    [point11, point44, point88, point55],
                    [point11, point22, point33, point44],
                    [point11, point22, point66, point55],
                    [point44, point88, point77, point33],
                    [point55, point66, point77, point88],
                    [point66, point22, point33, point77]
                ];
            ...
            _calculateRect3D: function(startX, startY, individualBarWidth, height, val, isValMoreZero, isValLessZero, serNum) {
                ...
                var facePoints = [
                    [point1, point5, point8, point4],
                    [point1, point2, point3, point4],
                    [point1, point2, point6, point5],
                    [point4, point3, point7, point8],
                    [point5, point6, point7, point8],
            ...
            _calculateStacked3D: function(prevPoints, seria, allPoints) {
                ...
                for (var i = 0; i < points.length - 1; i++) {
                    ...
                    var p2 = {
                        x: x,
                        y: y,
                        z: this.gapDepth + this.perspectiveDepth
                    };
                    var p3 = {
                        x: x1,
                        y: y1,
        ...
        drawHBarChart.prototype = {
            ...
            _recalculateBars: function( /*isSkip*/ ) {
                ...
                var width, startX, startY, val, paths, seriesHeight = [],
                    seria, startXColumnPosition, startYPosition, newStartX, newStartY, idx, seriesCounter = 0,
                    numCache;
        ...
        drawPieChart.prototype = {
            ...
            _calculateAngles3DPerspective: function(xCenter, yCenter, radius1, radius2, radius3D1, center3D1) {
                ...
                for (var i = numCache.ptCount; i >= 0; i--) {
                    ...
                    while (true) {
                        ...
                        newSwapAngle += getAngleByCoordsSidesTriangle({
                            x: p2.x - p1.x,
                            y: p2.y - p1.y
                        }, {
                            x: xCenter - p1.x,
                            ...
                            if (tempStartAngle - Math.PI / 2 > startAngle + swapAngle) {
                                ...
                                if (i !== numCache.ptCount) {
                                    angles.push({
                                        start: newStartAngle,
                                        swap: newSwapAngle,
                                        end: newStartAngle + newSwapAngle
                                    });
                                }
            ...
            _calculateSegment3DPerspective: function(radiusUp1, radiusUp2, radiusDown1, radiusDown2, angles1, angles2, center1, center2, pointCenter1, pointCenter2, upFaceSign) {
                var xCenter = center1.x,
                    yCenter = center1.y,
                    xCenter1 = center2.x,
                    yCenter1 = center2.y;
                var startAngle1 = angles1.start,
                    swapAngle1 = angles1.swap,
                    startAngle2 = angles2.start,
                    swapAngle2 = angles2.swap;
            ...
            _calculateInEndDLblPosition: function(fStartAngle, fSweepAngle, fPieRadius, fLabelWidth, fLabelHeight, fCenterX, fCenterY) {
                ...
                var fHalfRectWidthVector = fLabelWidth / 2,
                    fHalfRectHeightVector = fLabelHeight / 2;
                ...
                var fXs = fCenterX + fPieRadius * Math.cos(fBisectAngle),
                    fYs = fCenterY + fPieRadius * Math.sin(fBisectAngle);
                var a = fPieRadius * fPieRadius,
                    b = 2 * ((fXs - fCenterX) * fHalfRectWidthVector + (fYs - fCenterY) * fHalfRectHeightVector),
                    c = fHalfRectWidthVector * fHalfRectWidthVector + fHalfRectHeightVector * fHalfRectHeightVector - fPieRadius * fPieRadius;
            ...
            _calculateArc3D_Slow: function(radius, stAng, swAng, xCenter, yCenter, depth, seriaNum) {
                ...
                if (!this.usually3dPropsCalc[seriaNum]) {
                    this.usually3dPropsCalc[seriaNum] = {
                        swAng: swAng,
                        stAng: stAng,
                        xCenter: xCenter,
                        x0: x0,
        ...
        drawSurfaceChart.prototype = {
            ...
            _recalculate: function() {
                ...
                var y, x, z, val, seria, dataSeries, idx, numCache, idxPoint, points = [],
                    points3d = [],
                    idx2, val2;
                for (var i = 0; i < this.chart.series.length; i++) {
                    seria = this.chart.series[i];
            ...
            _getIntersectionPlanesAndLines: function(lines, pointsValue, bIsAddIntoPaths) {
                ...
                var getGridPlain = function(index) {
                    ...
                    var gridPlain = t.cChartDrawer.getPlainEquation({
                        x: gridX1,
                        y: gridY1,
                        z: 0
                    }, {
        ...
        floor3DChart.prototype = {
            ...
            _calculate: function() {
                ...
                if (point1) {
                    this.paths.chartFloor = this.cChartDrawer.calculatePolygon([{
                        x: point1.x / pxToMm,
                        y: point1.y / pxToMm
                    }, {
                        x: point2.x / pxToMm,
        ...
        sideWall3DChart.prototype = {
            ...
            _calculate: function() {
                ...
                this.paths = this.cChartDrawer.calculatePolygon([{
                    x: x1n,
                    y: y1n
                }, {
                    x: x2n,
