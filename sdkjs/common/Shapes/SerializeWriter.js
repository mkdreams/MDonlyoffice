...
(function(window, undefined) {
    ...
    function CBinaryFileWriter() {
        ...
        this.WriteCSld = function(cSld) {
            ...
            var uniPr = AscFormat.ExecuteNoHistory(function() {
                return new AscFormat.UniNvPr();
            }, this, []);
            uniPr.cNvPr.id = 1;
            uniPr.cNvPr.name = "";

            var spPr = AscFormat.ExecuteNoHistory(function() {
                return new AscFormat.CSpPr();
            }, this, []);
            spPr.xfrm = AscFormat.ExecuteNoHistory(function() {
                return new AscFormat.CXfrm();
            }, this, []);
            spPr.xfrm.offX = 0;
            spPr.xfrm.offY = 0;
            spPr.xfrm.extX = 0;
            ...
            if (undefined !== bullet && null != bullet) {
                ...
                if (bullet.bulletTypeface != null && bullet.bulletTypeface.type != null && bullet.bulletTypeface.type != AscFormat.BULLET_TYPE_TYPEFACE_NONE) {
                    ...
                    if (bullet.bulletTypeface.type == AscFormat.BULLET_TYPE_TYPEFACE_BUFONT) {
                        oThis.WriteRecord2(AscFormat.BULLET_TYPE_TYPEFACE_BUFONT, {
        ...
        this.WriteEffect = function(oEffect) {
            ...
            switch (type) {
                ...
                case 11:
                    /*EFFECT_TYPE_ALPHACEILING	=*/ {
                        oThis.StartRecord(type);
                        oThis.EndRecord();
                        break;
                    }
                case 12:
                    /*EFFECT_TYPE_ALPHAFLOOR		=*/ {
                        oThis.StartRecord(type);
                        oThis.EndRecord();
                        break;
                    }
                case 13:
                    /*EFFECT_TYPE_TINTEFFECT		=*/ {
                        oThis.StartRecord(type);
                        oThis.WriteUChar(g_nodeAttributeStart);
            ...
            for (var i = 0; i < _content_len; i++) {
                ...
                switch (_elem.Type) {
                    ...
                    case para_Hyperlink:
                        {
                            var _hObj = {
                                Value: _elem.GetValue(),
                                tooltip: _elem.GetToolTip()
                            };
                                    ...
                                    case para_Math:
                                        {
                                            if (null != _elem_h.Root) {
                                                ...
                                                boMaths.bs.WriteItemWithLength(function() {
                                                    boMaths.WriteOMathPara(_elem_h)
                                                });
        ...
        this.WriteImage = function(image) {
            ...
            if (image.spPr.geometry === undefined || image.spPr.geometry == null) {
                // powerpoint!
                bSetGeometry = true;
                image.spPr.geometry = AscFormat.ExecuteNoHistory(function() {
    ...
    function CPPTXContentWriter() {
        ...
        this.WriteShape = function(shape, Document, oMapCommentId, oNumIdMap, copyParams, saveParams) {
            ...
            _writer.WriteRecord1(0, {
                locks: shape.locks,
                objectType: shape.getObjectType()
            }, _writer.WriteUniNvPr);
