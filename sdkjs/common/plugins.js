...
(function(window, undefined) {
    ...
    function onMessage(event) {
        ...
        if ("initialize_internal" == name) {
            ...
            window.g_asc_plugins.api.sendEvent("asc_onPluginResize", [_sizes["width"], _sizes["height"]], [_sizes["minw"], _sizes["minh"]], [_sizes["maxw"], _sizes["maxh"]], function() {
