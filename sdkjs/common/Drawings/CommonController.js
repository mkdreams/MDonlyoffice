    ...
    function(window, undefined) {
        ...
        DrawingObjectsController.prototype = {
                                ...
                                if (!(this.noNeedUpdateCursorType === true)) {
                                    ...
                                    if (oDD) {
                                        ...
                                        MMData.Hyperlink = new Asc.CHyperlinkProperty({
                                            Text: null,
                                            Value: oNvPr.hlinkClick.id,
                                            ToolTip: oNvPr.hlinkClick.tooltip,
                                            Class: null
                                        });
                                        if (this.isSlideShow()) {
                        ...
                        for (i = aDrawings.length - 1; i > -1; --i) {
                            if (aDrawings[i].selected) {
                                ...
                                return {
                                    X: dX,
                                    Y: dY,
                                    PageIndex: this.selection.groupSelection.selectStartPage
                                };
                            }
                        }
                    } else {
            ...
            setCellSubscript: function(isSubscript) {
                ...
                var callBack = function() {
                    oThis.paragraphAdd(new ParaTextPr({
                        VertAlign: isSubscript ? AscCommon.vertalign_SubScript : AscCommon.vertalign_Baseline
                    }));
                };
            ...
            setCellSuperscript: function(isSuperscript) {
                ...
                var callBack = function() {
                    oThis.paragraphAdd(new ParaTextPr({
                        VertAlign: isSuperscript ? AscCommon.vertalign_SubScript : AscCommon.vertalign_Baseline
                    }));
                };
            ...
            setCellVertAlign: function(align) {
                ...
                }], false, AscDFH.historydescription_Spreadsheet_SetCellVertAlign);
            },
            ...
            setCellBackgroundColor: function(color) {
                ...
                this.checkSelectedObjectsAndCallback(this.applyDrawingProps, [{
                    fill: fill
                }], false, AscDFH.historydescription_Spreadsheet_SetCellBackgroundColor);
            },
                ...
                if (target_text_object) {
                    ...
                    if (this.selection.groupSelection) {
                        if (this.selection.groupSelection.selection.chartSelection) {
                            ...
                            var group_map = {},
                                group_arr = [],
                                i, cur_group, sp, xc, yc, hc, vc, rel_xc, rel_yc, j;
                            for (i = 0; i < this.selection.groupSelection.selectedObjects.length; ++i) {
            ...
            getChartObject: function(type, w, h) {
                if (null != type) {
                    return AscFormat.ExecuteNoHistory(function() {
                        ...
                        if (!ret) {
                            chartSeries = {
                                series: DrawingObjectsController.prototype.getSeriesDefault.call(this,
                                    c_oAscChartTypeSettings.barNormal),
                                parsedHeaders: {
                                    bLeft: true,
                                    bTop: true
                                }
            ...
            checkChartTextSelection: function(bNoRedraw) {
                ...
                if (chart_selection && (chart_selection.selection.textSelection || chart_selection.selection.title)) {
                    ...
                    var content = oTitle.getDocContent(),
                        bDeleteTitle = false;
                    if (content) {
                        if (content.Is_Empty()) {
            ...
            getDrawingPropsFromArray: function(drawings) {
                var image_props, shape_props, chart_props, table_props = undefined,
                    new_image_props, new_shape_props, new_chart_props, new_table_props, shape_chart_props, locked;
                var drawing;
            ...
            createTextArt: function(nStyle, bWord, wsModel, sStartString) {
                ...
                if (!bUseStartString) {
                    ...
                    oTextPr = new CTextPr();
                    oTextPr.FontSize = nFontSize;
                    oTextPr.RFonts.Ascii = {
                        Name: "Cambria Math",
                        Index: -1
                    };
                    oTextPr.RFonts.HAnsi = {
                        Name: "Cambria Math",
                        Index: -1
                    };
                    oTextPr.RFonts.CS = {
            ...
            alignLeft: function(bSelected) {
                var selected_objects = this.selection.groupSelection ? this.selection.groupSelection.selectedObjects : this.selectedObjects,
                    i, boundsObject, leftPos, arrBounds;
            ...
            alignRight: function(bSelected) {
                var selected_objects = this.selection.groupSelection ? this.selection.groupSelection.selectedObjects : this.selectedObjects,
                    i, boundsObject, rightPos, arrBounds;
                if (selected_objects.length > 0) {
                    boundsObject = getAbsoluteRectBoundsArr(selected_objects);
                    arrBounds = boundsObject.arrBounds;
                    if (bSelected && selected_objects.length > 1) {
            ...
            alignTop: function(bSelected) {
                var selected_objects = this.selection.groupSelection ? this.selection.groupSelection.selectedObjects : this.selectedObjects,
                    i, boundsObject, topPos, arrBounds;
                if (selected_objects.length > 0) {
                    boundsObject = getAbsoluteRectBoundsArr(selected_objects);
                    arrBounds = boundsObject.arrBounds;
                    if (bSelected && selected_objects.length > 1) {
            ...
            alignBottom: function(bSelected) {
                var selected_objects = this.selection.groupSelection ? this.selection.groupSelection.selectedObjects : this.selectedObjects,
                    i, boundsObject, bottomPos, arrBounds;
                if (selected_objects.length > 0) {
                    boundsObject = getAbsoluteRectBoundsArr(selected_objects);
                    arrBounds = boundsObject.arrBounds;
                    if (bSelected && selected_objects.length > 1) {
            ...
            alignCenter: function(bSelected) {
                var selected_objects = this.selection.groupSelection ? this.selection.groupSelection.selectedObjects : this.selectedObjects,
                    i, boundsObject, centerPos, arrBounds;
                if (selected_objects.length > 0) {
                    boundsObject = getAbsoluteRectBoundsArr(selected_objects);
                    arrBounds = boundsObject.arrBounds;
                    if (bSelected && selected_objects.length > 1) {
            ...
            alignMiddle: function(bSelected) {
                var selected_objects = this.selection.groupSelection ? this.selection.groupSelection.selectedObjects : this.selectedObjects,
                    i, boundsObject, middlePos, arrBounds;
                if (selected_objects.length > 0) {
                    boundsObject = getAbsoluteRectBoundsArr(selected_objects);
                    arrBounds = boundsObject.arrBounds;
                    if (bSelected && selected_objects.length > 1) {
            ...
            distributeHor: function(bSelected) {
                var selected_objects = this.selection.groupSelection ? this.selection.groupSelection.selectedObjects : this.selectedObjects,
                    i, boundsObject, arrBounds, pos1, pos2, gap, sortObjects, lastPos;
                if (selected_objects.length > 0) {
                    boundsObject = getAbsoluteRectBoundsArr(selected_objects);
                    arrBounds = boundsObject.arrBounds;
                    this.checkSelectedObjectsForMove(this.selection.groupSelection ? this.selection.groupSelection : null);
        ...
        function fCheckObjectHyperlink(object, x, y) {
            ...
            var invert_transform_text = object.invertTransformText,
                tx, ty, hit_paragraph, check_hyperlink, par;
            if (content && invert_transform_text) {
                tx = invert_transform_text.TransformPointX(x, y);
                ty = invert_transform_text.TransformPointY(x, y);
                hit_paragraph = content.Internal_GetContentPosByXY(tx, ty, 0);
