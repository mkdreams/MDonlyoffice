...
(
    ...
    function(window, undefined) {
        ...
        CChangesGeometryAddHandlePolar.prototype.AddHandlePolar = function() {
            this.Class.ahPolarLstInfo.push({
                gdRefR: this.gdRefR,
                minR: this.minR,
                maxR: this.maxR,
                gdRefAng: this.gdRefAng,
                minAng: this.minAng,
                maxAng: this.maxAng,
                posX: this.posX,
                posY: this.posY
        ...
        AscDFH.drawingsChangesMap[AscDFH.historyitem_GeometrySetPreset] = function(oClass, value) {
            oClass.preset = value;
        };
        AscDFH.drawingsChangesMap[AscDFH.historyitem_GeometrySetParent] = function(oClass, value) {
            oClass.parent = value;
        };
        ...
        AscDFH.drawingContentChanges[AscDFH.historyitem_GeometryAddPath] = function(oClass) {
            return oClass.pathLst;
        };
        ...
        Geometry.prototype = {
            ...
            drawConnectors: function(overlay, transform) {
                ...
                if (overlay.DrawEditWrapPointsPolygon) {
                    for (var i = 0; i < this.cnxLst.length; i++) {
                        overlay.DrawEditWrapPointsPolygon([{
                            x: this.cnxLst[i].x,
                            y: this.cnxLst[i].y
                        }], transform);
                    }
            ...
            getNewWHByTextRect: function(dTextWidth, dTextHeight, dGeometryWidth, dGeometryHeight) {
                ...
                var dWi = dTextWidth,
                    dHi = dTextHeight,
                    dWNext, dHNext;
                var oGeometry = AscFormat.ExecuteNoHistory(function() {
                ...
                if (!AscFormat.isRealNumber(dGeometryWidth) && !AscFormat.isRealNumber(dGeometryHeight)) {
                    ...
                    return {
                        W: dWi,
                        H: dHi,
                        bError: dDelta > EPSILON_TEXT_AUTOFIT
                    };
