    ...
    function(window, undefined) {
        ...
        CShape.prototype.checkTransformTextMatrix = function(oMatrix, oContent, oBodyPr, bWordArtTransform, bIgnoreInsets) {
            ...
            if (!oBodyPr.upright) {
                ...
                if (this.bWordShape) {
                    ...
                    oClipRect = {
                        x: oRect.l + l_ins - DiffLeft,
                        y: oRect.t - Diff + t_ins,
                        w: clipW,
                        h: clipH
                    };
                } else {
        ...
        CShape.prototype.recalculateTextStyles = function(level) {
            return AscFormat.ExecuteNoHistory(function() {
                ...
                if (parent_objects.theme) {
                    default_style.TextPr.RFonts.Ascii = {
                        Name: "+mn-lt",
                        Index: -1
                    };
                    default_style.TextPr.RFonts.EastAsia = {
                        Name: "+mn-ea",
                        Index: -1
                    };
                    default_style.TextPr.RFonts.CS = {
                        Name: "+mn-cs",
                        Index: -1
                    };
                    default_style.TextPr.RFonts.HAnsi = {
                        Name: "+mn-lt",
                        Index: -1
                    };
                }
        ...
        CShape.prototype.recalculateLocalTransform = function(transform) {
            AscFormat.ExecuteNoHistory(function() {
                ...
                if (!isRealObject(this.group)) {
                    ...
                    if (bUserShape) {} else if (this.drawingBase && !this.isCrop) {
                ...
                if (this.checkAutofit && this.checkAutofit() && (!this.bWordShape || !this.group || this.bCheckAutoFitFlag) && !bNotesShape) {
                    ...
                    var oGeometry = this.spPr && this.spPr.geometry,
                        oWH;
                    var dOldExtX = this.extX,
                        dOldExtY = this.extY,
                        dDeltaX = 0,
                        dDeltaY = 0;
                    ...
                    {
                        var dSin = Math.sin(this.rot),
                            dCos = Math.cos(this.rot);
                        var oContent = this.getDocContent();
                        var nJc, nAnchor;
        ...
        CShape.prototype.getHandlePosByIndex = function(numHandle) {
            ...
            switch (numHandle) {
                case 0:
                    return {
                        x: t.TransformPointX(0, 0),
                        y: t.TransformPointY(0, 0)
                    };
                case 1:
                    return {
                        x: t.TransformPointX(this.extX / 2.0, 0),
                        y: t.TransformPointY(this.extX / 2.0, 0)
                    };
                case 2:
                    return {
                        x: t.TransformPointX(this.extX, 0),
                        y: t.TransformPointY(this.extX, 0)
                    };
                case 3:
                    return {
                ...
                case 4:
                    return {
                        x: t.TransformPointX(this.extX, this.extY),
                        y: t.TransformPointY(this.extX, this.extY)
                    };
                case 5:
                    return {
                ...
                case 6:
                    return {
                        x: t.TransformPointX(0, this.extY),
                        y: t.TransformPointY(0, this.extY)
                    };
                case 7:
                    return {
                        x: t.TransformPointX(0, this.extY / 2.0),
                        y: t.TransformPointY(0, 0)
                    };
                default:
            }
        ...
        CShape.prototype.applyTextArtForm = function(sPreset) {
            ...
            oBodyPr.prstTxWarp = AscFormat.ExecuteNoHistory(function() {
                return AscFormat.CreatePrstTxWarpGeometry(sPreset)
            }, this, []);
            if (this.bWordShape) {
        ...
        CShape.prototype.getWatermarkProps = function() {
            var oProps = new Asc.CAscWatermarkProperties(),
                oTextPr, oRGBAColor, oInterfaceTextPr, oContent;
            oContent = this.getDocContent();
        ...
        CShape.prototype.checkTextWarp = function(oContent, oBodyPr, dWidth, dHeight, bNeedNoTransform, bNeedWarp) {
            return AscFormat.ExecuteNoHistory(function() {
                ...
                if (bTransform || bCheckWordArtContent) {
                    var bNeedRecalc = this.checkNeedRecalcDocContentForTxWarp(oBodyPr),
                        dOneLineWidth, dMinPolygonLength = 0,
                        dKoeff = 1;
                    var oTheme = this.Get_Theme(),
                        oColorMap = this.Get_ColorMap();
                    ...
                    if (bNeedRecalc && bNeedWarp) {
                        ...
                        oContentToDraw.SetParagraphSpacing({
                            Before: 0,
                            After: 0
                        });
                    ...
                    var OldShowParaMarks, width_ = dWidth * dKoeff,
                        height_ = dHeight * dKoeff;
