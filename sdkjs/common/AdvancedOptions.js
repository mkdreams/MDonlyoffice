...
(
    ...
    function(window, undefined) {
        ...
        asc_CDownloadOptions.prototype.asc_setFileType = function(fileType) {
            this.fileType = fileType;
        };
        asc_CDownloadOptions.prototype.asc_setIsDownloadEvent = function(isDownloadEvent) {
            this.isDownloadEvent = isDownloadEvent;
        };
        asc_CDownloadOptions.prototype.asc_setAdvancedOptions = function(advancedOptions) {
            this.advancedOptions = advancedOptions;
        };
        asc_CDownloadOptions.prototype.asc_setCompatible = function(compatible) {
        ...
        asc_CAdvancedOptions.prototype.asc_getCodePages = function() {
            return this.codePages;
        };
        asc_CAdvancedOptions.prototype.asc_getRecommendedSettings = function() {
            return this.recommendedSettings;
        };
        asc_CAdvancedOptions.prototype.asc_getData = function() {
            return this.data;
        };
        ...
        asc_CTextOptions.prototype.asc_getDelimiter = function() {
            return this.delimiter;
        };
        asc_CTextOptions.prototype.asc_setDelimiter = function(v) {
            this.delimiter = v;
        };
        asc_CTextOptions.prototype.asc_getDelimiterChar = function() {
            return this.delimiterChar;
        };
        asc_CTextOptions.prototype.asc_setDelimiterChar = function(v) {
            this.delimiterChar = v;
        };
        asc_CTextOptions.prototype.asc_getCodePage = function() {
            return this.codePage;
        };
        asc_CTextOptions.prototype.asc_setCodePage = function(v) {
            this.codePage = v;
        };
        ...
        asc_CDRMAdvancedOptions.prototype.asc_getPassword = function() {
            return this.password;
        };
        asc_CDRMAdvancedOptions.prototype.asc_setPassword = function(v) {
            this.password = v;
        };
        ...
        asc_CCodePage.prototype.asc_getCodePageName = function() {
            return this.codePageName;
        };
        asc_CCodePage.prototype.asc_setCodePageName = function(v) {
            this.codePageName = v;
        };
        asc_CCodePage.prototype.asc_getCodePage = function() {
            return this.codePage;
        };
        asc_CCodePage.prototype.asc_setCodePage = function(v) {
            this.codePage = v;
        };
        asc_CCodePage.prototype.asc_getText = function() {
            return this.text;
        };
        asc_CCodePage.prototype.asc_setText = function(v) {
            this.text = v;
        };
        asc_CCodePage.prototype.asc_getLcid = function() {
            return this.lcid;
        };
        asc_CCodePage.prototype.asc_setLcid = function(v) {
            this.lcid = v;
        };
        ...
        asc_CDelimiter.prototype.asc_getDelimiterName = function() {
            return this.delimiterName;
        };
        asc_CDelimiter.prototype.asc_setDelimiterName = function(v) {
        ...
        asc_CFormulaGroup.prototype.asc_getGroupName = function() {
            return this.groupName;
        };
        asc_CFormulaGroup.prototype.asc_getFormulasArray = function() {
            return this.formulasArray;
        };
        asc_CFormulaGroup.prototype.asc_addFormulaElement = function(o) {
