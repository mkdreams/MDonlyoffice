...
background-repeat: no-repeat;\
    ...
    asc_docs_api.prototype.OpenDocument2 = function(url, gObject) {
        ...
        var openParams = {
            checkFileSize: /*this.isMobileVersion*/ false,
            charCount: 0,
            parCount: 0
        };
    ...
    asc_docs_api.prototype.asc_CheckCopy = function(_clipboard /* CClipboardData */ , _formats) {
        if (!this.WordControl.m_oLogicDocument) {
            var _text_object = (AscCommon.c_oAscClipboardDataFormat.Text & _formats) ? {
                Text: ""
            } : null;
    ...
    asc_docs_api.prototype.sync_TextPrFontFamilyCallBack = function(FontFamily) {
        if (undefined != FontFamily)
            ...
            this.sendEvent("asc_onFontFamily", new asc_CTextFontFamily({
                Name: "",
                Index: -1
            }));
    };
    ...
    asc_docs_api.prototype.AddImageUrlAction = function(url, imgProp, obj) {
        ...
        if (null != _image) {
            ...
            if (obj && obj.isShapeImageChangeUrl) {
                ...
                this.ImgApply(new asc_CImgProperty({
    ...
    asc_docs_api.prototype.ImgApply = function(obj) {
        ...
        if (!AscCommon.isRealObject(obj))
            return;
        var ImagePr = obj,
            AdditionalData, LogicDocument = this.WordControl.m_oLogicDocument;
        ...
        var aParagraphs = [],
            aSelectedObjects = this.WordControl.m_oLogicDocument.DrawingObjects.selectedObjects,
            i, j, oParentParagraph;
    ...
    window["asc_docs_api"].prototype.asc_nativeGetFile3 = function() {
        ...
        return {
            ...
            header: (AscCommon.c_oSerFormat.Signature + ";v" + Asc.c_nVersionNoBase64 + ";" + oBinaryFileWriter.memory.GetCurPosition() + ";")
        };
    };
