...
(function(window, undefined) {
    ...
    StartAddNewShape.prototype = {
        ...
        onMouseUp: function(e, x, y, pageIndex) {
            ...
            if (this.bStart && this.drawingObjects.arrTrackObjects.length > 0) {
                ...
                if (nearest_pos && false === oLogicDocument.Document_Is_SelectionLocked(AscCommon.changestype_None, {
        ...
        onMouseUp: function(e, x, y, pageIndex) {
            ...
            if (this.majorObject.parent.Is_Inline()) {
                ...
                if (this.bSamePos !== true) {
                    var aCheckParagraphs = [],
                        aNearestPos = [],
                        aParentParagraphs = [],
                        aBounds = [],
                        aDrawings = [],
                        bMoveState = (this instanceof MoveState),
                        nearest_pos;
    ...
    ResizeState.prototype = {
        onMouseDown: function(e, x, y, pageIndex) {
            ...
            if (this.drawingObjects.handleEventMode === HANDLE_EVENT_MODE_CURSOR)
                return {
                    cursorType: AscFormat.CURSOR_TYPES_BY_CARD_DIRECTION[this.cardDirection] ? AscFormat.CURSOR_TYPES_BY_CARD_DIRECTION[this.cardDirection] : "default",
                    objectId: this.majorObject.Get_Id()
                };
        },
    ...
    AddPolyLine2State.prototype = {
        onMouseDown: function(e, x, y, pageIndex) {
            ...
            this.drawingObjects.arrPreTrackObjects[0].arrPoint.push({
                x: x,
                y: y
            });
