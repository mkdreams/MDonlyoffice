 ...
 * @returns {boolean}
 */
CDocumentControllerBase.prototype.CanUpdateTarget = function() {
    return true;
};
/**
 ...
 */
CDocumentControllerBase.prototype.RecalculateCurPos = function(bUpdateX, bUpdateY) {
    return {
        X: 0,
        Y: 0,
        Height: 0,
 ...
 */
CDocumentControllerBase.prototype.GetCurPage = function() {
    return -1;
};
/**
 ...
 */
CDocumentControllerBase.prototype.AddNewParagraph = function(bRecalculate, bForceAdd) {
    return false;
};
/**
 ...
 * @returns {?CTable}
 */
CDocumentControllerBase.prototype.AddInlineTable = function(nCols, nRows, nMode) {
    return null;
};
/**
 ...
 */
CDocumentControllerBase.prototype.Remove = function(nDirection, isRemoveWholeElement, bRemoveOnlySelection, bOnAddText, isWord) {
    return true;
};
/**
 * Получаем физическую позицию курсора на странице.
 */
CDocumentControllerBase.prototype.GetCursorPosXY = function() {
    return {
        X: 0,
        Y: 0
    };
 ...
 */
CDocumentControllerBase.prototype.MoveCursorLeft = function(AddToSelect, Word) {
    return false;
};
/**
 ...
 * @returns {boolean} Получилось ли перемещение, или мы достигли предела.
 */
CDocumentControllerBase.prototype.MoveCursorRight = function(AddToSelect, Word) {
    return false;
};
/**
 ...
 * @returns {boolean} Получилось ли перемещение, или мы достигли предела.
 */
CDocumentControllerBase.prototype.MoveCursorUp = function(AddToSelect) {
    return false;
};
/**
 * Смещаем курсор вниз.
 ...
 * @returns {boolean} Получилось ли перемещение, или мы достигли предела.
 */
CDocumentControllerBase.prototype.MoveCursorDown = function(AddToSelect) {
    return false;
};
/**
 ...
 * @returns {boolean} Получилось ли перемещение, или мы достигли предела.
 */
CDocumentControllerBase.prototype.MoveCursorToEndOfLine = function(AddToSelect) {
    return false;
};
/**
 ...
 * @returns {boolean} Получилось ли перемещение, или мы достигли предела.
 */
CDocumentControllerBase.prototype.MoveCursorToStartOfLine = function(AddToSelect) {
    return false;
};
/**
 ...
 * @returns {CParaPr}
 */
CDocumentControllerBase.prototype.GetCalculatedParaPr = function() {
 ...
 * @returns {CTextPr}
 */
CDocumentControllerBase.prototype.GetCalculatedTextPr = function() {
 ...
 * @returns {CParaPr}
 */
CDocumentControllerBase.prototype.GetDirectParaPr = function() {
    var oParaPr = new CParaPr();
    oParaPr.Init_Default();
    return oParaPr
};
 ...
 * @returns {CTextPr}
 */
CDocumentControllerBase.prototype.GetDirectTextPr = function() {
    var oTextPr = new CTextPr();
    oTextPr.Init_Default();
    return oTextPr
};
 ...
 * @returns {boolean}
 */
CDocumentControllerBase.prototype.IsSelectionEmpty = function(bCheckHidden) {
    return true;
};
/**
 ...
 * @returns {*}
 */
CDocumentControllerBase.prototype.GetSelectionBounds = function() {
    return null;
};
/**
 ...
 * @returns {boolean}
 */
CDocumentControllerBase.prototype.IsMovingTableBorder = function() {
    return false;
};
/**
 ...
 * @returns {boolean}
 */
CDocumentControllerBase.prototype.CheckPosInSelection = function(X, Y, PageAbs, NearPos) {
    return false;
};
/**
 ...
 * @returns {boolean}
 */
CDocumentControllerBase.prototype.IsSelectionUse = function() {
    return false;
};
/**
 ...
 * @returns {boolean}
 */
CDocumentControllerBase.prototype.IsNumberingSelection = function() {
    return false;
};
/**
 ...
 * @returns {boolean}
 */
CDocumentControllerBase.prototype.IsTextSelectionUse = function() {
    return false;
};
/**
 ...
 */
CDocumentControllerBase.prototype.GetCurPosXY = function() {
    return {
        X: 0,
        Y: 0
    };
 ...
 * @returns {String}
 */
CDocumentControllerBase.prototype.GetSelectedText = function(bClearText, oPr) {
    return "";
};
/**
 ...
 * @returns {?Paragraph}
 */
CDocumentControllerBase.prototype.GetCurrentParagraph = function(bIgnoreSelection, arrSelectedParagraphs, oPr) {
    return null
};
/**
 ...
 * @returns {boolean}
 */
CDocumentControllerBase.prototype.CanMergeTableCells = function() {
    return false;
};
/**
 ...
 * @returns {boolean}
 */
CDocumentControllerBase.prototype.CanSplitTableCells = function() {
    return false;
};
/**
 ...
 */
CDocumentControllerBase.prototype.GetSelectionState = function() {
    return [];
};
/**
 ...
 * @returns {boolean}
 */
CDocumentControllerBase.prototype.CanAddHyperlink = function(bCheckInHyperlink) {
    return false;
};
/**
 ...
 */
CDocumentControllerBase.prototype.IsCursorInHyperlink = function(bCheckEnd) {
    return false;
};
/**
 ...
 * @returns {boolean}
 */
CDocumentControllerBase.prototype.CanAddComment = function() {
    return false;
};
/**
 ...
 */
CDocumentControllerBase.prototype.GetSelectionAnchorPos = function() {
    return {
        X0: 0,
        X1: 0,
        Y: 0,
 ...
 */
CDocumentControllerBase.prototype.GetColumnSize = function() {
    return {
        W: 0,
        H: 0
    };
 ...
 * @returns {?CSectionPr}
 */
CDocumentControllerBase.prototype.GetCurrentSectionPr = function() {
    return null;
};
/**
 ...
 */
CDocumentControllerBase.prototype.AddContentControl = function(nContentControlType) {
    return null;
};
/**
 * Получаем стиль по выделенному фрагменту
 */
CDocumentControllerBase.prototype.GetStyleFromFormatting = function() {
    return null;
};
/**
 ...
 * @returns {?Object}
 */
CDocumentControllerBase.prototype.GetPlaceHolderObject = function() {
    return null;
};
/**
 ...
 * @returns {Array}
 */
CDocumentControllerBase.prototype.GetAllFields = function(isUseSelection, arrFields) {
 ...
 * @returns {boolean}
 */
CDocumentControllerBase.prototype.IsTableCellSelection = function() {
    return false;
};
