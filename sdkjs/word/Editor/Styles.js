...
CStyle.prototype = {
    ...
    RecalculateRelatedParagraphs: function() {
        ...
        if (this.Id != Styles.Default.Paragraph) {
            ...
            AllParagraphs = oHistory.GetAllParagraphsForRecalcData({
                Style: true,
                StylesId: AllStylesId
            });
        ...
        for (var Index = 0; Index < Count; Index++) {
            ...
            Para.Refresh_RecalcData({
                Type: AscDFH.historyitem_Paragraph_PStyle
            });
        }
    },
    //-----------------------------------------------------------------------------------
    ...
    Load_LinkData: function(LinkData) {
        if (true === LinkData.StyleUpdate) {
            ...
            if (this.Id != Styles.Default.Paragraph) {
                ...
                AllParagraphs = LogicDocument.GetAllParagraphs({
                    All: true
                });
                LogicDocument.Add_ChangedStyle([this.Id]);
            }
...
CTableCellPr.prototype.Merge = function(CellPr) {
    ...
    if (undefined === CellPr.TableCellMar) {} else if (null === CellPr.TableCellMar)
...
CTextPr.prototype.Merge = function(TextPr) {
    ...
    if (undefined === TextPr.HighLight) {} else if (highlight_None === TextPr.HighLight)
