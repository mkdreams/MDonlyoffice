...
CBlockLevelSdt.prototype.SetDocPartObj = function(sCategory, sGallery, isUnique) {
    History.Add(new CChangesSdtPrDocPartObj(this, this.Pr.DocPartObj, {
        Category: sCategory,
        Gallery: sGallery,
        Unique: isUnique
    }));
...
CBlockLevelSdt.prototype.private_UpdateCheckBoxContent = function() {
    ...
    if (isChecked && this.Pr.CheckBox.CheckedFont) {
        oRun.Set_RFonts_Ascii({
            Index: -1,
            Name: this.Pr.CheckBox.CheckedFont
        });
        ...
        oRun.Set_RFonts_Ascii({
            Index: -1,
            Name: this.Pr.CheckBox.UncheckedFont
        });
        oRun.Set_RFonts_HAnsi({
            Index: -1,
            Name: this.Pr.CheckBox.UncheckedFont
