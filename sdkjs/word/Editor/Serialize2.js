...
function WriteTrackRevision(bs, Id, reviewInfo, options) {
    //increment id
    bs.WriteItem(c_oSerProp_RevisionType.Id, function() {
    ...
    if (options) {
        if (null != options.run) {
            bs.WriteItem(c_oSerProp_RevisionType.Content, function() {
                options.run();
            });
        }
        if (null != options.runContent) {
            bs.WriteItem(c_oSerProp_RevisionType.ContentRun, function() {
                options.runContent();
            });
        }
        if (null != options.rPr) {
            bs.WriteItem(c_oSerProp_RevisionType.rPrChange, function() {
                options.brPrs.Write_rPr(options.rPr, null, null);
            });
        }
        if (null != options.pPr) {
            bs.WriteItem(c_oSerProp_RevisionType.pPrChange, function() {
                options.bpPrs.Write_pPr(options.pPr);
            });
        }
        if (null != options.grid) {
            bs.WriteItem(c_oSerProp_RevisionType.tblGridChange, function() {
                options.btw.WriteTblGrid(options.grid);
            });
        }
        if (null != options.tblPr) {
            bs.WriteItem(c_oSerProp_RevisionType.tblPrChange, function() {
                options.btw.WriteTblPr(options.tblPr);
            });
        }
        if (null != options.trPr) {
            bs.WriteItem(c_oSerProp_RevisionType.trPrChange, function() {
                options.btw.WriteRowPr(options.trPr);
            });
        }
        if (null != options.tcPr) {
            bs.WriteItem(c_oSerProp_RevisionType.tcPrChange, function() {
                options.btw.WriteCellPr(options.tcPr);
            });
        }
    }
};
...
function readBookmarkStart(length, bcr, oReadResult, oParStruct, openParams) {
    ...
    if (undefined !== bookmark.BookmarkId && undefined !== bookmark.BookmarkName) {
        ...
        if (!isCopyPaste || (isCopyPaste && bookmarksManager && null === bookmarksManager.GetBookmarkByName(bookmark.BookmarkName))) {
            ...
            oReadResult.bookmarksStarted[bookmark.BookmarkId] = {
                parent: oParStruct.getElem(),
...
function BinaryFileWriter(doc, bMailMergeDocx, bMailMergeHtml, isCompatible) {
    ...
    this.CopySdt = function(Item) {
        ...
        this.bs.WriteItem(c_oSerParType.Sdt, function() {
            oThis.copyParams.bdtw.WriteSdt(Item, 0);
        });
        this.copyParams.itemCount++;
    }
...
function BinaryStyleTableWriter(memory, doc, oNumIdMap, copyParams, saveParams) {
    ...
    this.WriteStylesContent = function() {
        ...
        this.bs.WriteItem(c_oSer_st.DefrPr, function() {
            oThis.brPrs.Write_rPr(oDef_rPr, null, null);
        });
        //styles
    ...
    this.WriteStyle = function(id, style, bDefault) {
        ...
        if (style.IsCustom())
            this.bs.WriteItem(c_oSer_sts.Style_CustomStyle, function() {
    ...
    this.WriteTblStyleProperty = function(oProp) {
        ...
        if (null != val.TextPr)
            this.bs.WriteItem(c_oSerProp_tblStylePrType.RunPr, function() {
                oThis.brPrs.Write_rPr(val.TextPr, null, null);
            });
        if (null != val.ParaPr)
...
function Binary_pPrWriter(memory, oNumIdMap, oBinaryHeaderFooterTableWriter, saveParams) {
    ...
    this.Write_pPr = function(pPr, pPr_rPr, EndRun, SectPr, oDocument) {
        ...
        if (null != pPr_rPr && null != EndRun) {
            ...
            this.memory.WriteByte(c_oSerPropLenType.Variable);
            this.bs.WriteItemWithLength(function() {
                oThis.brPrs.Write_rPr(pPr_rPr, EndRun.Pr, EndRun);
            });
        }
        //pBdr
        if (null != pPr.Brd) {
        ...
        if (null != pPr.PrChange && pPr.ReviewInfo) {
            ...
            this.memory.WriteByte(c_oSerPropLenType.Variable);
            this.bs.WriteItemWithLength(function() {
                WriteTrackRevision(oThis.bs, oThis.saveParams.trackRevisionId++, pPr.ReviewInfo, {
                    bpPrs: bpPrs,
                    pPr: pPr.PrChange
                });
            });
    ...
    this.WriteSectPr = function(sectPr, oDocument) {
        ...
        if (null != sectPr.Columns)
            this.bs.WriteItem(c_oSerProp_secPrType.cols, function() {
                oThis.WriteColumns(sectPr.Columns);
            });
        if (null != sectPr.Borders && !sectPr.Borders.IsEmptyBorders())
            this.bs.WriteItem(c_oSerProp_secPrType.pgBorders, function() {
                oThis.WritePgBorders(sectPr.Borders);
            });
        if (null != sectPr.FootnotePr)
            this.bs.WriteItem(c_oSerProp_secPrType.footnotePr, function() {
                oThis.WriteFootnotePr(sectPr.FootnotePr);
            });
        if (sectPr.IsGutterRTL())
            this.bs.WriteItem(c_oSerProp_secPrType.rtlGutter, function() {
                oThis.memory.WriteBool(true);
            });
    };
    this.WriteFootnotePr = function(footnotePr) {
        ...
        if (null != footnotePr.NumRestart) {
            this.bs.WriteItem(c_oSerNotes.PrRestart, function() {
                oThis.memory.WriteByte(footnotePr.NumRestart);
            });
        }
        if (null != footnotePr.NumFormat) {
            this.bs.WriteItem(c_oSerNotes.PrFmt, function() {
                oThis.WriteNumFmt(footnotePr.NumFormat);
            });
        }
        if (null != footnotePr.NumStart) {
            this.bs.WriteItem(c_oSerNotes.PrStart, function() {
                oThis.memory.WriteLong(footnotePr.NumStart);
            });
        }
        if (null != footnotePr.Pos) {
            this.bs.WriteItem(c_oSerNotes.PrFntPos, function() {
                oThis.memory.WriteByte(footnotePr.Pos);
            });
        }
    };
    this.WriteNumFmt = function(fmt) {
        ...
        this.bs.WriteItem(c_oSerNumTypes.NumFmtVal, function() {
            oThis.memory.WriteByte(val);
        });
    };
    ...
    this.WritePageSetting = function(sectPr, oDocument) {
        ...
        switch (sectPr.Get_Type()) {
            case c_oAscSectionBreakType.Continuous:
                nFormatType = ESectionMark.sectionmarkContinuous;
                break;
    ...
    this.WriteColumns = function(cols) {
        ...
        if (null != cols.EqualWidth) {
            this.bs.WriteItem(c_oSerProp_Columns.EqualWidth, function() {
                oThis.memory.WriteBool(cols.EqualWidth);
            });
        }
        if (null != cols.Num) {
            this.bs.WriteItem(c_oSerProp_Columns.Num, function() {
                oThis.memory.WriteLong(cols.Num);
            });
        }
        if (null != cols.Sep) {
            this.bs.WriteItem(c_oSerProp_Columns.Sep, function() {
                oThis.memory.WriteBool(cols.Sep);
            });
        }
        if (null != cols.Space) {
            this.bs.WriteItem(c_oSerProp_Columns.Space, function() {
                oThis.bs.writeMmToTwips(cols.Space);
            });
        }
        for (var i = 0; i < cols.Cols.length; ++i) {
            this.bs.WriteItem(c_oSerProp_Columns.Column, function() {
                oThis.WriteColumn(cols.Cols[i]);
            });
        }
    }
    this.WriteColumn = function(col) {
        var oThis = this;
        if (null != col.Space) {
            this.bs.WriteItem(c_oSerProp_Columns.ColumnSpace, function() {
                oThis.bs.writeMmToTwips(col.Space);
            });
        }
        if (null != col.W) {
            this.bs.WriteItem(c_oSerProp_Columns.ColumnW, function() {
                oThis.bs.writeMmToTwips(col.W);
            });
        }
    }
    this.WritePgBorders = function(pageBorders) {
        ...
        if (null != pageBorders.Display) {
            this.bs.WriteItem(c_oSerPageBorders.Display, function() {
                oThis.memory.WriteByte(pageBorders.Display);
            });
        }
        if (null != pageBorders.OffsetFrom) {
            this.bs.WriteItem(c_oSerPageBorders.OffsetFrom, function() {
                oThis.memory.WriteByte(pageBorders.OffsetFrom);
            });
        }
        if (null != pageBorders.ZOrder) {
            this.bs.WriteItem(c_oSerPageBorders.ZOrder, function() {
                oThis.memory.WriteByte(pageBorders.ZOrder);
            });
        }
        if (null != pageBorders.Bottom && !pageBorders.Bottom.IsNone()) {
            this.bs.WriteItem(c_oSerPageBorders.Bottom, function() {
                oThis.WritePgBorder(pageBorders.Bottom);
            });
        }
        if (null != pageBorders.Left && !pageBorders.Left.IsNone()) {
            this.bs.WriteItem(c_oSerPageBorders.Left, function() {
                oThis.WritePgBorder(pageBorders.Left);
            });
        }
        if (null != pageBorders.Right && !pageBorders.Right.IsNone()) {
            this.bs.WriteItem(c_oSerPageBorders.Right, function() {
                oThis.WritePgBorder(pageBorders.Right);
            });
        }
        if (null != pageBorders.Top && !pageBorders.Top.IsNone()) {
            this.bs.WriteItem(c_oSerPageBorders.Top, function() {
                oThis.WritePgBorder(pageBorders.Top);
            });
        }
    }
    this.WritePgBorder = function(border) {
        ...
        if (null != border.Value) {
            ...
            if (null != border.Unifill || (null != border.Color && border.Color.Auto)) {
                ...
                this.memory.WriteByte(c_oSerPropLenType.Variable);
                this.bs.WriteItemWithLength(function() {
                    _this.bs.WriteColorTheme(border.Unifill, border.Color);
                });
            }
...
function Binary_rPrWriter(memory, saveParams) {
    ...
    this.Write_rPr = function(rPr, rPrReview, EndRun) {
        ...
        if (null != rPr.TextOutline) {
            ...
            this.memory.WriteByte(c_oSerPropLenType.Variable);
            this.bs.WriteItemWithLength(function() {
                pptx_content_writer.WriteSpPr(_this.memory, rPr.TextOutline, 0);
            });
        }
        if (null != rPr.TextFill) {
            ...
            this.bs.WriteItemWithLength(function() {
                pptx_content_writer.WriteSpPr(_this.memory, rPr.TextFill, 1);
            });
            if (null != rPr.TextFill.transparent) {
                rPr.TextFill.transparent = 255 - rPr.TextFill.transparent;
            }
        ...
        if (rPrReview && rPrReview.PrChange && rPrReview.ReviewInfo) {
            ...
            this.memory.WriteByte(c_oSerPropLenType.Variable);
            this.bs.WriteItemWithLength(function() {
                WriteTrackRevision(_this.bs, _this.saveParams.trackRevisionId++, rPrReview.ReviewInfo, {
                    brPrs: brPrs,
                    rPr: rPrReview.PrChange
                });
            });
        }
        if (EndRun && EndRun.ReviewInfo) {
            ...
            if (recordType) {
                ...
                this.memory.WriteByte(c_oSerPropLenType.Variable);
                this.bs.WriteItemWithLength(function() {
                    WriteTrackRevision(_this.bs, _this.saveParams.trackRevisionId++, EndRun.ReviewInfo);
                });
            }
        }
    };
...
function Binary_oMathWriter(memory, oMathPara, saveParams) {
            ...
            switch (item.Type) {
                ...
                case para_Math_BreakOperator:
                    this.bs.WriteItem(c_oSer_OMathContentType.MText, function() {
                        oThis.memory.WriteString2(AscCommon.convertUnicodeToUTF16([item.value]));
                    }); //m:t
                    break;
                case para_Math_Run:
                    this.WriteMRunWrap(item, isSingle);
    ...
    this.WriteMRun = function(oMRun) {
        ...
        if (reviewtype_Common !== reviewType) {
            writeNestedReviewType(reviewType, oMRun.GetReviewInfo(), function(reviewType, reviewInfo, delText, fCallback) {
                ...
                oThis.bs.WriteItem(recordType, function() {
                    WriteTrackRevision(oThis.bs, oThis.saveParams.trackRevisionId++, reviewInfo, {
                        runContent: function() {
                            fCallback();
                        }
                    });
    ...
    this.WriteMRunContent = function(oMRun) {
        ...
        for (var CurPos = 0; CurPos < ContentLen; CurPos++) {
            ...
            switch (Item.Type) {
                ...
                case para_Math_BreakOperator:
                case para_Math_Text:
                    oText += AscCommon.convertUnicodeToUTF16([Item.value]);
                    break;
                case para_Space:
                case para_Tab:
                    oText += " ";
        ...
        if (null != props.wRPrp) {
            this.bs.WriteItem(c_oSer_OMathContentType.RPr, function() {
                oThis.brPrs.Write_rPr(props.wRPrp, null, null);
            }); // w:rPr
        }
        ...
        if (oElem.Is_FromDocument()) {
            if (reviewtype_Remove == ReviewType || reviewtype_Add == ReviewType && oElem.ReviewInfo) {
                ...
                this.bs.WriteItem(recordType, function() {
                    WriteTrackRevision(oThis.bs, oThis.saveParams.trackRevisionId++, oElem.ReviewInfo, {
                        brPrs: brPrs,
                        rPr: oElem.CtrPrp
                    });
                });
                ...
                this.bs.WriteItem(c_oSerRunType.rPr, function() {
                    oThis.brPrs.Write_rPr(oElem.CtrPrp, null, null);
                });
            }
        } else {
    ...
    this.WriteMcJc = function(MJc) {
        ...
        switch (MJc) {
            case MCJC_CENTER:
                val = c_oAscXAlign.Center;
                break;
            case MCJC_INSIDE:
                val = c_oAscXAlign.Inside;
                break;
            case MCJC_LEFT:
                val = c_oAscXAlign.Left;
                break;
            case MCJC_OUTSIDE:
                val = c_oAscXAlign.Outside;
                break;
            case MCJC_RIGHT:
                val = c_oAscXAlign.Right;
                break;
        }
        this.memory.WriteByte(val);
...
Binary_tblPrWriter.prototype = {
    ...
    WriteTblPr: function(tblPr, table) {
        ...
        if (null != tblPr.TableStyleRowBandSize) {
            this.bs.WriteItem(c_oSerProp_tblPrType.RowBandSize, function() {
                oThis.memory.WriteLong(tblPr.TableStyleRowBandSize);
            });
        }
        if (null != tblPr.TableStyleColBandSize) {
            this.bs.WriteItem(c_oSerProp_tblPrType.ColBandSize, function() {
                oThis.memory.WriteLong(tblPr.TableStyleColBandSize);
            });
        }
        //Jc
        if (null != tblPr.Jc) {
        ...
        if (null != tblPr.TableInd) {
            this.bs.WriteItem(c_oSerProp_tblPrType.TableIndTwips, function() {
                oThis.bs.writeMmToTwips(tblPr.TableInd);
            });
        }
        //TableW
        ...
        if (null != tblPr.TableCellSpacing) {
            this.bs.WriteItem(c_oSerProp_tblPrType.TableCellSpacingTwips, function() {
                oThis.bs.writeMmToTwips(tblPr.TableCellSpacing / 2);
            });
        }
        ...
        if (tblPr.PrChange && tblPr.ReviewInfo) {
            this.bs.WriteItem(c_oSerProp_tblPrType.tblPrChange, function() {
                WriteTrackRevision(oThis.bs, oThis.saveParams.trackRevisionId++, tblPr.ReviewInfo, {
                    btw: oThis,
                    tblPr: tblPr.PrChange
                });
            });
        }
    },
    ...
    WriteRowPr: function(rowPr, row) {
        ...
        if (rowPr.PrChange && rowPr.ReviewInfo) {
            ...
            this.memory.WriteByte(c_oSerPropLenType.Variable);
            this.bs.WriteItemWithLength(function() {
                WriteTrackRevision(oThis.bs, oThis.saveParams.trackRevisionId++, rowPr.ReviewInfo, {
                    btw: oThis,
                    trPr: rowPr.PrChange
                });
            });
        ...
        if (row) {
            ...
            if (reviewtype_Add === ReviewType || reviewtype_Remove === ReviewType) {
                ...
                this.memory.WriteByte(c_oSerPropLenType.Variable);
                this.bs.WriteItemWithLength(function() {
                    WriteTrackRevision(oThis.bs, oThis.saveParams.trackRevisionId++, row.GetReviewInfo());
                });
            }
        }
    },
    ...
    WriteCellPr: function(cellPr, vMerge, cell) {
        ...
        if (cellPr.PrChange && cellPr.ReviewInfo) {
            ...
            this.memory.WriteByte(c_oSerPropLenType.Variable);
            this.bs.WriteItemWithLength(function() {
                WriteTrackRevision(oThis.bs, oThis.saveParams.trackRevisionId++, cellPr.ReviewInfo, {
                    btw: oThis,
                    tcPr: cellPr.PrChange
                });
            });
        }
    }
...
function BinaryNumberingTableWriter(memory, doc, oNumIdMap, oUsedNumIdMap, saveParams) {
            ...
            for (i in this.oUsedNumIdMap) {
                if (this.oUsedNumIdMap.hasOwnProperty(i) && nums[i]) {
                    this.bs.WriteItem(c_oSerNumTypes.Num, function() {
                        oThis.WriteNum(nums[i], oThis.oUsedNumIdMap[i]);
                    });
                }
            }
        } else {
    ...
    this.WriteNum = function(num, index) {
        ...
        for (var nLvl = 0; nLvl < 9; ++nLvl) {
            if (num.LvlOverride[nLvl]) {
                ...
                this.memory.WriteByte(c_oSerPropLenType.Variable);
                this.bs.WriteItemWithLength(function() {
                    oThis.WriteLvlOverride(num.LvlOverride[nLvl]);
                });
            }
        }
    ...
    this.WriteLvlOverride = function(lvlOverride) {
        ...
        if (lvlOverride.Lvl >= 0) {
            this.bs.WriteItem(c_oSerNumTypes.ILvl, function() {
                oThis.memory.WriteLong(lvlOverride.Lvl);
            });
        }
        if (lvlOverride.StartOverride >= 0) {
            this.bs.WriteItem(c_oSerNumTypes.StartOverride, function() {
                oThis.memory.WriteLong(lvlOverride.StartOverride);
            });
        }
        if (lvlOverride.NumberingLvl && lvlOverride.Lvl >= 0) {
            this.bs.WriteItem(c_oSerNumTypes.Lvl, function() {
                oThis.WriteLevel(lvlOverride.NumberingLvl, lvlOverride.Lvl);
            });
        }
    };
        ...
        if (null != this.oUsedNumIdMap) {
                ...
                if (this.oUsedNumIdMap.hasOwnProperty(i) && nums[i]) {
                    ...
                    if (null != ANum) {
                        this.bs.WriteItem(c_oSerNumTypes.AbstractNum, function() {
                            oThis.WriteAbstractNum(ANum, index);
                        });
                        index++;
                    }
                }
            ...
            for (i in ANums) {
                if (ANums.hasOwnProperty(i)) {
                    this.bs.WriteItem(c_oSerNumTypes.AbstractNum, function() {
                        oThis.WriteAbstractNum(ANums[i], index);
                    });
                    index++;
                }
            }
    ...
    this.WriteLevel = function(lvl, ILvl) {
        ...
        if (null != lvl.Format) {
            ...
            this.memory.WriteByte(c_oSerPropLenType.Variable);
            this.bs.WriteItemWithLength(function() {
                oThis.bpPrs.WriteNumFmt(lvl.Format);
            });
        }
        //Jc
        if (null != lvl.Jc) {
        ...
        if (null != lvl.TextPr) {
            ...
            this.memory.WriteByte(c_oSerPropLenType.Variable);
            this.bs.WriteItemWithLength(function() {
                oThis.brPrs.Write_rPr(lvl.TextPr, null, null);
            });
        }
        if (null != ILvl) {
        ...
        if (null != lvl.Legacy) {
            ...
            this.memory.WriteByte(c_oSerPropLenType.Variable);
            this.bs.WriteItemWithLength(function() {
                oThis.WriteLvlLegacy(lvl.Legacy);
            });
        }
    };
    this.WriteLvlLegacy = function(lvlLegacy) {
        ...
        if (null != lvlLegacy.Legacy) {
            this.bs.WriteItem(c_oSerNumTypes.Legacy, function() {
                oThis.memory.WriteBool(lvlLegacy.Legacy);
            });
        }
        if (null != lvlLegacy.Indent) {
            this.bs.WriteItem(c_oSerNumTypes.LegacyIndent, function() {
                oThis.memory.WriteLong(lvlLegacy.Indent);
            });
        }
        if (null != lvlLegacy.Space) {
            this.bs.WriteItem(c_oSerNumTypes.LegacySpace, function() {
                oThis.memory.WriteLong(AscFonts.FT_Common.UintToInt(lvlLegacy.Space))
            });
        }
    };
...
function BinaryDocumentTableWriter(memory, doc, oMapCommentId, oNumIdMap, copyParams, saveParams, oBinaryHeaderFooterTableWriter) {
    ...
    this.WriteDocumentContent = function(oDocument, bIsMainDoc) {
        ...
        if (bIsMainDoc) {
            ...
            if (oThis.Document.Background) {
                this.bs.WriteItem(c_oSerParType.Background, function() {
                    oThis.WriteBackground(oThis.Document.Background);
                });
            }
    ...
    this.WriteBackground = function(oBackground) {
        ...
        if (null != oBackground.Unifill || (null != oBackground.Color && oBackground.Color.Auto)) {
            ...
            this.memory.WriteByte(c_oSerPropLenType.Variable);
            this.bs.WriteItemWithLength(function() {
                oThis.bs.WriteColorTheme(oBackground.Unifill, oBackground.Color);
            });
        }
        if (oBackground.shape) {
            ...
            this.memory.WriteByte(c_oSerPropLenType.Variable);
            this.bs.WriteItemWithLength(function() {
                oThis.WriteGraphicObj(oBackground.shape);
            });
        }
    }
    this.WriteParapraph = function(par, bUseSelection, selectedAll) {
        ...
        if (null != pPr || null != ParaStyle) {
            ...
            this.bs.WriteItemWithLength(function() {
                oThis.bpPrs.Write_pPr(pPr, par.TextPr.Value, EndRun, par.Get_SectionPr(), oThis.Document);
            });
        }
        //Content
        if (null != par.Content) {
                    ...
                    if (null !== Instr) {
                        if (this.saveParams && this.saveParams.bMailMergeDocx)
                            ...
                            this.bs.WriteItem(c_oSerParType.FldSimple, function() {
                                oThis.WriteFldSimple(Instr, oFFData, function() {
                                    oThis.WriteParagraphContent(item, bUseSelection, false);
                                });
                            });
                        }
                        ...
                        if (null != item.Root) {
                            if (this.saveParams && this.saveParams.bMailMergeHtml) {
                                ...
                                if (type_Paragraph === par.GetType() && true === par.Check_MathPara(i)) {
                                    ...
                                    this.bs.WriteItem(c_oSerParType.OMath, function() {
                                        oThis.boMaths.WriteArgNodes(item.Root);
                                    });
                                }
                            }
                        }
        ...
        this.bs.WriteItem(c_oSerParType.Run, function() {
            ...
            if (null != oRun && null != oRun.Pr)
                oThis.bs.WriteItem(c_oSerRunType.rPr, function() {
                    oThis.brPrs.Write_rPr(oRun.Pr, oRun.Pr, null);
                });
            //Content
    ...
    this.WriteRun = function(oRun, bUseSelection, delText) {
        ...
        for (var i = 0, length = aRunRanges.length; i < length; i++) {
            ...
            if (null != elem.pageNum) {
                ...
                this.bs.WriteItem(c_oSerParType.FldSimple, function() {
                    oThis.WriteFldSimple(Instr, null, function() {
            ...
            switch (item.Type) {
                ...
                case para_FootnoteReference:
                    ...
                    oThis.bs.WriteItem(c_oSerRunType.footnoteReference, function() {
                        oThis.WriteFootnoteRef(item);
                    });
                    break;
                case para_FieldChar:
                    sCurText = this.WriteText(sCurText, textType);
                    sCurInstrText = this.WriteText(sCurInstrText, instrTextType);
                    oThis.bs.WriteItem(c_oSerRunType.fldChar, function() {
                        oThis.WriteFldChar(item);
                    });
                    break;
                case para_InstrText:
                    sCurText = this.WriteText(sCurText, textType);
                ...
                case para_Drawing:
                    ...
                    if (this.copyParams && item.ParaMath) {
                        oThis.bs.WriteItem(c_oSerRunType.object, function() {
                            oThis.WriteObject(item);
                        });
                    } else {
                        oThis.bs.WriteItem(c_oSerRunType.pptxDrawing, function() {
    ...
    this.WriteFootnoteRef = function(footnoteReference) {
        ...
        if (null != footnoteReference.CustomMark) {
            this.bs.WriteItem(c_oSerNotes.RefCustomMarkFollows, function() {
                oThis.memory.WriteBool(footnoteReference.CustomMark);
            });
        }
        var index = this.saveParams.footnotesIndex++;
        this.saveParams.footnotes[index] = {
            type: null,
            content: footnote
        };
        this.bs.WriteItem(c_oSerNotes.RefId, function() {
            oThis.memory.WriteLong(index);
        });
    };
    this.WriteGraphicObj = function(graphicObj) {
        ...
        this.memory.WriteByte(c_oSerPropLenType.Variable);
        this.bs.WriteItemWithLength(function() {
            pptx_content_writer.WriteDrawing(oThis.memory, graphicObj, oThis.Document, oThis.oMapCommentId, oThis.oNumIdMap, oThis.copyParams, oThis.saveParams);
        });
    }
    this.WriteImage = function(img) {
        ...
        if (drawing_Inline == img.DrawingType) {
            ...
            if (img.EffectExtent) {
                ...
                this.memory.WriteByte(c_oSerPropLenType.Variable);
                this.bs.WriteItemWithLength(function() {
                    oThis.WriteEffectExtent(img.EffectExtent);
                });
            }
            if (null != img.GraphicObj.locks) {
                ...
                this.memory.WriteByte(c_oSerPropLenType.Variable);
                this.bs.WriteItemWithLength(function() {
                    oThis.WriteGraphicFramePr(img.GraphicObj.locks);
                });
            }
            if (null != img.docPr) {
            ...
            if (null != img.SizeRelH) {
                ...
                this.memory.WriteByte(c_oSerPropLenType.Variable);
                this.bs.WriteItemWithLength(function() {
                    oThis.WriteSizeRelHV(img.SizeRelH);
                });
            }
            if (null != img.SizeRelV) {
                ...
                this.memory.WriteByte(c_oSerPropLenType.Variable);
                this.bs.WriteItemWithLength(function() {
                    oThis.WriteSizeRelHV(img.SizeRelV);
                });
            }
    ...
    this.WriteDocPr = function(docPr) {
        var oThis = this;
        this.bs.WriteItem(c_oSerDocPr.Id, function() {
            oThis.memory.WriteLong(oThis.saveParams.docPrId++);
        });
        if (null != docPr.name) {
        ...
        if (null != docPr.isHidden) {
            this.bs.WriteItem(c_oSerDocPr.Hidden, function() {
                oThis.memory.WriteBool(docPr.isHidden);
            });
        }
        if (null != docPr.title) {
    ...
    this.WriteDocTable = function(table, aRowElems, nMinGrid, nMaxGrid) {
        ...
        if (null != table.TableGrid) {
            ...
            this.bs.WriteItem(c_oSerDocTableType.tblGrid, function() {
                oThis.WriteTblGrid(aGrid, table.TableGridChange);
            });
        }
        //Content
    ...
    this.WriteTblGrid = function(grid, tableGridChange) {
        ...
        if (tableGridChange) {
            ...
            this.memory.WriteByte(c_oSerPropLenType.Variable);
            this.bs.WriteItemWithLength(function() {
                WriteTrackRevision(oThis.bs, oThis.saveParams.trackRevisionId++, undefined, {
                    btw: oThis,
                    grid: tableGridChange
                });
            });
        }
    };
    ...
    this.WriteRow = function(Row, nRowIndex, oRowElem) {
        ...
        if (null != Row.Pr) {
            ...
            this.bs.WriteItem(c_oSerDocTableType.Row_Pr, function() {
                oThis.btblPrs.WriteRowPr(oRowPr, Row);
            });
        }
        //Content
        if (null != Row.Content) {
    ...
    this.WriteCell = function(cell, nRowIndex, nColIndex) {
        ...
        if (null != cell.Pr) {
            ...
            this.bs.WriteItem(c_oSerDocTableType.Cell_Pr, function() {
                oThis.btblPrs.WriteCellPr(cell.Pr, vMerge, cell);
            });
        }
        //Content
    ...
    this.WriteObject = function(obj) {
        ...
        oThis.bs.WriteItem(c_oSerParType.OMath, function() {
            oThis.boMaths.WriteArgNodes(obj.ParaMath.Root);
        });
        oThis.bs.WriteItem(c_oSerRunType.pptxDrawing, function() {
            oThis.WriteImage(obj);
        });
    };
    this.WriteSdt = function(oSdt, type) {
        var oThis = this;
        if (oSdt.Pr) {
            oThis.bs.WriteItem(c_oSerSdt.Pr, function() {
                oThis.WriteSdtPr(oSdt.Pr, oSdt);
            });
        }
        // if (oSdt.EndPr) {
        ...
        if (0 === type) {
            var oInnerDocument = new BinaryDocumentTableWriter(this.memory, this.Document, this.oMapCommentId, this.oNumIdMap, this.copyParams, this.saveParams, this.oBinaryHeaderFooterTableWriter);
            this.bs.WriteItem(c_oSerSdt.Content, function() {
                oInnerDocument.WriteDocumentContent(oSdt.Content);
            });
        } else if (1 === type) {
            this.bs.WriteItem(c_oSerSdt.Content, function() {
                oThis.WriteParagraphContent(oSdt, false, false);
            });
        }
    };
    this.WriteSdtPr = function(val, oSdt) {
        ...
        if (null != val.Appearance) {
            oThis.bs.WriteItem(c_oSerSdt.Appearance, function() {
                oThis.memory.WriteByte(val.Appearance);
            });
        }
        if (null != val.Color) {
            var rPr = new CTextPr();
            rPr.Color = val.Color;
            oThis.bs.WriteItem(c_oSerSdt.Color, function() {
                oThis.brPrs.Write_rPr(rPr, null, null);
            });
        }
        ...
        // }
        if (null != val.Id) {
            oThis.bs.WriteItem(c_oSerSdt.Id, function() {
                oThis.memory.WriteLong(val.Id);
            });
        }
        if (null != val.Label) {
            oThis.bs.WriteItem(c_oSerSdt.Label, function() {
                oThis.memory.WriteLong(val.Label);
            });
        }
        if (null != val.Lock) {
            oThis.bs.WriteItem(c_oSerSdt.Lock, function() {
                oThis.memory.WriteByte(val.Lock);
            });
        }
        ...
        if (rPr) {
            this.bs.WriteItem(c_oSerSdt.RPr, function() {
                oThis.brPrs.Write_rPr(rPr, null, null);
            });
        }
        ...
        if (oSdt.IsComboBox()) {
            ...
            oThis.bs.WriteItem(c_oSerSdt.ComboBox, function() {
                oThis.WriteSdtComboBox(oSdt.GetComboBoxPr());
            });
        } else if (oSdt.IsPicture()) {
            type = ESdtType.sdttypePicture;
        } else if (val.IsBuiltInDocPart()) {
            type = ESdtType.sdttypeDocPartObj;
            oThis.bs.WriteItem(c_oSerSdt.DocPartObj, function() {
                oThis.WriteDocPartList(val.DocPartObj);
            });
        } else if (oSdt.IsDropDownList()) {
            type = ESdtType.sdttypeDropDownList;
            oThis.bs.WriteItem(c_oSerSdt.DropDownList, function() {
                oThis.WriteSdtComboBox(oSdt.GetDropDownListPr());
            });
        } else if (oSdt.IsDatePicker()) {
            type = ESdtType.sdttypeDate;
            oThis.bs.WriteItem(c_oSerSdt.PrDate, function() {
                oThis.WriteSdtPrDate(oSdt.GetDatePickerPr());
            });
        } else if (undefined !== val.CheckBox) {
            type = ESdtType.sdttypeCheckBox;
            oThis.bs.WriteItem(c_oSerSdt.Checkbox, function() {
                oThis.WriteSdtCheckBox(val.CheckBox);
            });
        }
        if (undefined !== type) {
            oThis.bs.WriteItem(c_oSerSdt.Type, function() {
                oThis.memory.WriteByte(type);
            });
        }
    };
    this.WriteSdtCheckBox = function(val) {
        var oThis = this;
        if (null != val.Checked) {
            oThis.bs.WriteItem(c_oSerSdt.CheckboxChecked, function() {
                oThis.memory.WriteBool(val.Checked);
            });
        }
        if (null != val.CheckedFont) {
            oThis.bs.WriteItem(c_oSerSdt.CheckboxCheckedFont, function() {
                oThis.memory.WriteString3(val.CheckedFont);
            });
        }
        if (null != val.CheckedSymbol) {
            oThis.bs.WriteItem(c_oSerSdt.CheckboxCheckedVal, function() {
                oThis.memory.WriteLong(val.CheckedSymbol);
            });
        }
        if (null != val.UncheckedFont) {
            oThis.bs.WriteItem(c_oSerSdt.CheckboxUncheckedFont, function() {
                oThis.memory.WriteString3(val.UncheckedFont);
            });
        }
        if (null != val.UncheckedSymbol) {
            oThis.bs.WriteItem(c_oSerSdt.CheckboxUncheckedVal, function() {
                oThis.memory.WriteLong(val.UncheckedSymbol);
            });
        }
    };
    this.WriteSdtComboBox = function(val) {
        ...
        if (null != val.ListItems) {
            for (var i = 0; i < val.ListItems.length; ++i) {
                oThis.bs.WriteItem(c_oSerSdt.SdtListItem, function() {
                    oThis.WriteSdtListItem(val.ListItems[i]);
                });
            }
        }
    };
    ...
    this.WriteSdtPrDate = function(val) {
        ...
        if (null != val.Calendar) {
            oThis.bs.WriteItem(c_oSerSdt.Calendar, function() {
                oThis.memory.WriteByte(val.Calendar);
            });
        }
    ...
    this.WriteDocPartList = function(val) {
        ...
        if (null != val.Unique) {
            oThis.bs.WriteItem(c_oSerSdt.DocPartUnique, function() {
                oThis.memory.WriteBool(val.Unique);
            });
        }
    };
};
...
function BinaryOtherTableWriter(memory, doc) {
    ...
    this.WriteOtherContent = function() {
        ...
        this.bs.WriteItem(c_oSerOtherTableTypes.DocxTheme, function() {
            pptx_content_writer.WriteTheme(oThis.memory, oThis.Document.theme);
        });
    };
};
...
function BinaryCommentsTableWriter(memory, doc, oMapCommentId, commentUniqueGuids, isDocument) {
    ...
    this.WriteComment = function(comment, sCommentId, nFileId) {
        ...
        if (null != comment.m_nDurableId) {
            ...
            this.bs.WriteItem(c_oSer_CommentsType.DurableId, function() {
                oThis.memory.WriteULong(comment.m_nDurableId);
            });
        }
...
function BinarySettingsTableWriter(memory, doc, saveParams) {
    ...
    this.WriteSettings = function() {
        ...
        this.bs.WriteItem(c_oSer_SettingsType.DefaultTabStopTwips, function() {
            oThis.bs.writeMmToTwips(AscCommonWord.Default_Tab_Stop);
        });
        this.bs.WriteItem(c_oSer_SettingsType.MathPr, function() {
            oThis.WriteMathPr();
        });
        this.bs.WriteItem(c_oSer_SettingsType.TrackRevisions, function() {
            oThis.memory.WriteBool(oThis.Document.IsTrackRevisions());
        });
        this.bs.WriteItem(c_oSer_SettingsType.FootnotePr, function() {
            oThis.WriteFootnotePr();
        });
        if (oThis.Document.Settings && oThis.Document.Settings.DecimalSymbol) {
            this.bs.WriteItem(c_oSer_SettingsType.DecimalSymbol, function() {
                oThis.memory.WriteString3(oThis.Document.Settings.DecimalSymbol);
            });
        }
        if (oThis.Document.Settings && oThis.Document.Settings.ListSeparator) {
            this.bs.WriteItem(c_oSer_SettingsType.ListSeparator, function() {
                oThis.memory.WriteString3(oThis.Document.Settings.ListSeparator);
            });
        }
        if (oThis.Document.IsGutterAtTop()) {
            this.bs.WriteItem(c_oSer_SettingsType.GutterAtTop, function() {
                oThis.memory.WriteBool(true);
            });
        }
        if (oThis.Document.IsMirrorMargins()) {
            this.bs.WriteItem(c_oSer_SettingsType.MirrorMargins, function() {
                oThis.memory.WriteBool(true);
            });
        }
        ...
        if (!oThis.Document.IsSdtGlobalSettingsDefault()) {
            ...
            this.bs.WriteItem(c_oSer_SettingsType.SdtGlobalColor, function() {
                oThis.brPrs.Write_rPr(rPr, null, null);
            });
            this.bs.WriteItem(c_oSer_SettingsType.SdtGlobalShowHighlight, function() {
                oThis.memory.WriteBool(oThis.Document.GetSdtGlobalShowHighlight());
            });
        }
        this.bs.WriteItem(c_oSer_SettingsType.Compat, function() {
            oThis.WriteCompat();
        });
    }
    this.WriteCompat = function() {
        ...
        this.bs.WriteItem(c_oSerCompat.CompatSetting, function() {
            oThis.WriteCompatSetting("compatibilityMode", "http://schemas.microsoft.com/office/word", compatibilityMode.toString());
        });
        this.bs.WriteItem(c_oSerCompat.CompatSetting, function() {
            oThis.WriteCompatSetting("overrideTableStyleFontSizeAndJustification", "http://schemas.microsoft.com/office/word", "1");
        });
        this.bs.WriteItem(c_oSerCompat.CompatSetting, function() {
            oThis.WriteCompatSetting("enableOpenTypeFeatures", "http://schemas.microsoft.com/office/word", "1");
        });
        this.bs.WriteItem(c_oSerCompat.CompatSetting, function() {
            oThis.WriteCompatSetting("doNotFlipMirrorIndents", "http://schemas.microsoft.com/office/word", "1");
        });
        var flags1 = 0;
        if (this.saveParams.isCompatible) {
            flags1 |= (oThis.Document.IsDoNotExpandShiftReturn() ? 1 : 0) << 10;
        }
        this.bs.WriteItem(c_oSerCompat.Flags1, function() {
            oThis.memory.WriteULong(flags1);
        });
        var flags2 = 0;
        if (this.saveParams.isCompatible) {
            flags2 |= (oThis.Document.IsSplitPageBreakAndParaMark() ? 1 : 0) << 27;
        }
        this.bs.WriteItem(c_oSerCompat.Flags2, function() {
            oThis.memory.WriteULong(flags2);
        });
    };
    this.WriteCompatSetting = function(name, uri, value) {
        var oThis = this;
        this.bs.WriteItem(c_oSerCompat.CompatName, function() {
            oThis.memory.WriteString3(name);
        });
        this.bs.WriteItem(c_oSerCompat.CompatUri, function() {
            oThis.memory.WriteString3(uri);
        });
        this.bs.WriteItem(c_oSerCompat.CompatValue, function() {
            oThis.memory.WriteString3(value);
        });
    };
    this.WriteFootnotePr = function() {
        ...
        if (this.Document.Footnotes.SeparatorFootnote) {
            this.saveParams.footnotes[index] = {
                type: 3,
                content: this.Document.Footnotes.SeparatorFootnote
            };
            this.bs.WriteItem(c_oSerNotes.PrRef, function() {
                oThis.memory.WriteLong(index);
            });
            index++
        }
        if (this.Document.Footnotes.ContinuationSeparatorFootnote) {
            this.saveParams.footnotes[index] = {
                type: 1,
                content: this.Document.Footnotes.ContinuationSeparatorFootnote
            };
            this.bs.WriteItem(c_oSerNotes.PrRef, function() {
                oThis.memory.WriteLong(index);
            });
        ...
        if (this.Document.Footnotes.ContinuationNoticeFootnote) {
            this.saveParams.footnotes[index] = {
                type: 0,
                content: this.Document.Footnotes.ContinuationNoticeFootnote
            };
            this.bs.WriteItem(c_oSerNotes.PrRef, function() {
                oThis.memory.WriteLong(index);
            });
...
function BinaryNotesTableWriter(memory, doc, oNumIdMap, oMapCommentId, copyParams, saveParams) {
    ...
    this.WriteNotes = function() {
        ...
        for (var i = 0; i < indexes.length; ++i) {
            ...
            this.bs.WriteItem(c_oSerNotes.Note, function() {
                oThis.WriteNote(index, footnote.type, footnote.content);
            });
        }
    };
    this.WriteNote = function(index, type, footnote) {
        var oThis = this;
        if (null != type) {
            this.bs.WriteItem(c_oSerNotes.NoteType, function() {
                oThis.memory.WriteByte(type);
            });
        }
        this.bs.WriteItem(c_oSerNotes.NoteId, function() {
            oThis.memory.WriteLong(index);
        });
        ...
        this.bs.WriteItem(c_oSerNotes.NoteContent, function() {
            dtw.WriteDocumentContent(footnote);
        });
    };
};
        ...
        for (var i in this.oReadResult.styles) {
            ...
            if (true == oNewId.def) {
                switch (oNewStyle.Type) {
                    case styletype_Character:
                        stDefault.Character = sNewStyleId;
                        break;
                    case styletype_Numbering:
                        stDefault.Numbering = sNewStyleId;
                        break;
                    case styletype_Paragraph:
                        stDefault.Paragraph = sNewStyleId;
                        break;
                    case styletype_Table:
                        stDefault.Table = sNewStyleId;
                        break;
                }
            }
...
function Binary_pPrReader(doc, oReadResult, stream) {
        ...
        switch (type) {
            ...
            case c_oSerProp_pPrType.pPrChange:
                if (null != this.paragraph && this.oReadResult.checkReadRevisions() && (!this.oReadResult.bCopyPaste || this.oReadResult.isDocumentPasting())) {
                    ...
                    res = this.bcr.Read1(length, function(t, l) {
                        return ReadTrackRevision(t, l, oThis.stream, reviewInfo, {
                            bpPrr: bpPrr,
                            pPr: pPrChange
                        });
                    });
    ...
    this.ReadInd = function(type, length, Ind) {
        ...
        switch (type) {
            ...
            case c_oSerProp_pPrType.Ind_LeftTwips:
                Ind.Left = g_dKoef_twips_to_mm * this.stream.GetULongLE();
                break;
            case c_oSerProp_pPrType.Ind_RightTwips:
                Ind.Right = g_dKoef_twips_to_mm * this.stream.GetULongLE();
                break;
            case c_oSerProp_pPrType.Ind_FirstLineTwips:
                Ind.FirstLine = g_dKoef_twips_to_mm * this.stream.GetULongLE();
                break;
            default:
                res = c_oSerConstants.ReadUnknown;
                break;
    ...
    this.ReadSpacing = function(type, length, Spacing, spacingTmp) {
        ...
        switch (type) {
            ...
            case c_oSerProp_pPrType.Spacing_LineTwips:
                spacingTmp.lineTwips = this.stream.GetULongLE();
                break;
            ...
            case c_oSerProp_pPrType.Spacing_BeforeTwips:
                Spacing.Before = g_dKoef_twips_to_mm * this.stream.GetULongLE();
                break;
            case c_oSerProp_pPrType.Spacing_After:
                Spacing.After = this.bcr.ReadDouble();
                break;
            case c_oSerProp_pPrType.Spacing_AfterTwips:
                Spacing.After = g_dKoef_twips_to_mm * this.stream.GetULongLE();
                break;
    ...
    this.ReadNumFmt = function(type, length, props) {
        ...
        if (c_oSerNumTypes.NumFmtVal === type) {
            switch (this.stream.GetByte()) {
                case 48:
                    props.Format = Asc.c_oAscNumberingFormat.None;
                    break;
                case 5:
                    props.Format = Asc.c_oAscNumberingFormat.Bullet;
                    break;
                case 13:
                    props.Format = Asc.c_oAscNumberingFormat.Decimal;
                    break;
                case 47:
                    props.Format = Asc.c_oAscNumberingFormat.LowerRoman;
                    break;
                case 61:
                    props.Format = Asc.c_oAscNumberingFormat.UpperRoman;
                    break;
                case 46:
                    props.Format = Asc.c_oAscNumberingFormat.LowerLetter;
                    break;
                case 60:
                    props.Format = Asc.c_oAscNumberingFormat.UpperLetter;
                    break;
                case 21:
                    props.Format = Asc.c_oAscNumberingFormat.DecimalZero;
                    break;
                case 14:
                    props.Format = Asc.c_oAscNumberingFormat.DecimalEnclosedCircle;
                    break;
                case 15:
                    props.Format = Asc.c_oAscNumberingFormat.DecimalEnclosedCircle;
                    break;
    ...
    this.Read_setting = function(type, length, oSectPr, oAdditional) {
        ...
        if (c_oSerProp_secPrSettingsType.titlePg === type) {
            ...
            switch (this.stream.GetByte()) {
                case ESectionMark.sectionmarkContinuous:
                    nEditorType = c_oAscSectionBreakType.Continuous;
                    break;
                case ESectionMark.sectionmarkEvenPage:
                    nEditorType = c_oAscSectionBreakType.EvenPage;
                    break;
                case ESectionMark.sectionmarkNextColumn:
                    nEditorType = c_oAscSectionBreakType.Column;
                    break;
                case ESectionMark.sectionmarkNextPage:
                    nEditorType = c_oAscSectionBreakType.NextPage;
                    break;
                case ESectionMark.sectionmarkOddPage:
                    nEditorType = c_oAscSectionBreakType.OddPage;
                    break;
            }
            if (null != nEditorType)
    ...
    this.ReadContent = function(type, length, run) {
        ...
        switch (type) {
            ...
            case c_oSerProp_rPrType.RStyle:
                ...
                this.oReadResult.runStyles.push({
                    pPr: rPr,
                    style: RunStyle,
                    run: run
                });
...
function Binary_NumberingTableReader(doc, oReadResult, stream) {
    ...
    this.ReadNumberingContent = function(type, length) {
        ...
        this.ReadAbstractNum = function(type, length, oNewNum) {
            ...
            if (c_oSerNumTypes.AbstractNum_Lvls === type) {
                ...
                this.oReadResult.numStyleLinks.push({
                    pPr: oNewNum,
                    style: this.stream.GetString2LE(length)
                });
            } else if (c_oSerNumTypes.StyleLink === type) {
                this.oReadResult.styleLinks.push({
                    pPr: oNewNum,
                    style: this.stream.GetString2LE(length)
                });
    ...
    this.ReadLevel = function(type, length, oNewLvl, tmp) {
        ...
        if (c_oSerNumTypes.lvl_Format === type) {
            ...
            switch (jc) {
                case 1:
                    oNewLvl.Jc = align_Center;
                    break;
                case 8:
                case 10:
                    oNewLvl.Jc = align_Left;
                    break;
                case 3:
                case 11:
                    oNewLvl.Jc = align_Right;
                    break;
                case 0:
                case 9:
                case 2:
                    oNewLvl.Jc = align_Justify;
                    break;
                default:
                    oNewLvl.Jc = align_Left;
                    break;
...
function Binary_oMathReader(stream, oReadResult, curFootnote, openParams) {
    ...
    this.ReadMathArg = function(type, length, oElem, oParStruct) {
        ...
        if (c_oSer_OMathContentType.Acc === type) {
            ...
            res = this.bcr.Read1(length, function(t, l) {
                return ReadTrackRevision(t, l, oThis.stream, reviewInfo, {
                    parStruct: oSdtStruct,
                    bdtr: oThis.oReadResult.bdtr
                });
            });
            if (oElem) {
...
function Binary_SettingsTableReader(doc, oReadResult, stream) {
    ...
    this.ReadMathDefJc = function(type, length, props) {
        ...
        if (c_oSer_OMathBottomNodesValType.Val === type) {
            ...
            switch (defJc) {
                case c_oAscMathJc.Center:
                    props.defJc = align_Center;
                    break;
                case c_oAscMathJc.CenterGroup:
                    props.defJc = align_Justify;
                    break;
                case c_oAscMathJc.Left:
                    props.defJc = align_Left;
                    break;
                case c_oAscMathJc.Right:
                    props.defJc = align_Right;
                    break;
                default:
                    props.defJc = align_Justify;
            }
