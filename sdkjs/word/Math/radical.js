...
CSignRadical.prototype.draw = function(x, y, pGraphics, PDSE) {
    ...
    var xx1 = this.pos.x + x,
        yy1 = hTick + 0.03 * FontSize,
        xx2 = xx1 + penW1 * sin1,
        yy2 = yy1 + penW1 * cos1,
        xx3 = xx2 + 0.03 * FontSize,
        yy3 = tg1 * (xx2 - xx3) + yy2;
    ...
    var xx5 = xx4 + shift,
        yy5 = yy4,
        xx6 = xx1 + this.measure.widthSlash,
        yy6 = this.pos.y + y + penW3,
        xx7 = this.pos.x + x + this.size.width,
        yy7 = yy6,
        xx8 = xx7,
        yy8 = yy7 - penW3;
...
CMathMenuRadical.prototype.get_HideDegree = function() {
    return this.HideDegree;
};
CMathMenuRadical.prototype.put_HideDegree = function(Hide) {
    this.HideDegree = Hide;
};
