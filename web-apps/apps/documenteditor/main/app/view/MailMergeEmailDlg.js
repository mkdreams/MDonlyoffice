...
define(['text!documenteditor/main/app/template/MailMergeEmailDlg.template',
    ...
    DE.Views.MailMergeEmailDlg = Common.Views.AdvancedSettingsWindow.extend(_.extend({
        ...
        initialize: function(options) {
            _.extend(this.options, {
                ...
                template: [
                    ...
                    '<div class="content-panel" style="padding: 0;">' + _.template(contentTemplate)({
                        scope: this
                    }) + '</div>',
                    '</div>',
        ...
        render: function() {
            ...
            this._arrFormat = [{
                    displayValue: this.textHTML,
                    value: Asc.c_oAscFileType.HTML
                },
                {
                    displayValue: this.textAttachDocx,
                    value: Asc.c_oAscFileType.DOCX
                },
                {
                    displayValue: this.textAttachPdf,
