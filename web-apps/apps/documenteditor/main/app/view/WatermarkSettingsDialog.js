...
define(['text!documenteditor/main/app/template/WatermarkSettings.template',
            ...
            Common.Utils.loadConfig('resources/watermark/wm-text.json', function(langJson) {
                for (var lang in langJson) {
                    ...
                    if (val) {
                        langs.push({
                            code: val,
                            name: Common.util.LanguageInfo.getLocalLanguageName(val)[1],
                            shortname: Common.util.LanguageInfo.getLocalLanguageName(val)[0],
                            text: langJson[lang]
                        });
                    }
                }
    ...
    DE.Views.WatermarkSettingsDialog = Common.Views.AdvancedSettingsWindow.extend(_.extend({
        ...
        initialize: function(options) {
            ...
            this.lang = val ? {
                value: lang,
                displayValue: Common.util.LanguageInfo.getLocalLanguageName(val)[1],
                default: true
            } : {
                value: 'en',
        ...
        render: function() {
            ...
            this.cmbScale = new Common.UI.ComboBox({
                ...
                data: this._arrScale
            }).on('selected', _.bind(function(combo, record) {}, this));
        ...
        afterRender: function() {
            ...
            this.cmbFonts.selectRecord(this.fontStore.findWhere({
                name: this.fontName
            }));
        ...
        loadWMText: function(lang) {
            ...
            if (!item)
                item = this.cmbLang.store.findWhere({
