    ...
    DE.Views.FileMenu = Common.UI.BaseView.extend(_.extend({
        ...
        applyMode: function() {
            if (!this.panels) {
                this.panels = {
                    'opts': (new DE.Views.FileMenuPanels.Settings({
                        menu: this
                    })).render(this.$el.find('#panel-settings')),
                    'info': (new DE.Views.FileMenuPanels.DocumentInfo({
                        menu: this
                    })).render(this.$el.find('#panel-info')),
                    'rights': (new DE.Views.FileMenuPanels.DocumentRights({
                        menu: this
                    })).render(this.$el.find('#panel-rights'))
                };
            }
            ...
            if (!this.customizationDone) {
                ...
                Common.Utils.applyCustomization(this.mode.customization, {
                    goback: '#fm-btn-back > a'
                });
            }
            ...
            if (this.mode.canCreateNew) {
                if (this.mode.templates && this.mode.templates.length) {
                    ...
                    !this.panels['new'] && (this.panels['new'] = ((new DE.Views.FileMenuPanels.CreateNew({
                        menu: this,
            ...
            if (this.mode.canOpenRecent && this.mode.recent) {
                !this.panels['recent'] && (this.panels['recent'] = (new DE.Views.FileMenuPanels.RecentFiles({
                    menu: this,
            ...
            if (this.mode.canProtect) {
                !this.panels['protect'] && (this.panels['protect'] = (new DE.Views.FileMenuPanels.ProtectDoc({
                    menu: this
                })).render());
            ...
            if (this.mode.canDownload) {
                !this.panels['saveas'] && (this.panels['saveas'] = ((new DE.Views.FileMenuPanels.ViewSaveAs({
                    menu: this
                })).render()));
            ...
            if (this.mode.canDownload && (this.mode.canRequestSaveAs || this.mode.saveAsUrl)) {
                !this.panels['save-copy'] && (this.panels['save-copy'] = ((new DE.Views.FileMenuPanels.ViewSaveCopy({
                    menu: this
                })).render()));
            }

            if (this.mode.canHelp && !this.panels['help']) {
                this.panels['help'] = ((new DE.Views.FileMenuPanels.Help({
                    menu: this
                })).render());
