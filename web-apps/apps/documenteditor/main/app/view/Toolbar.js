...
define([
    ...
    'common/main/lib/component/ComboDataView', 'common/main/lib/component/SynchronizeTip', 'common/main/lib/component/Mixtbar'
            ...
            applyLayout: function(config) {
                ...
                if (config.isEdit) {
                    Common.UI.Mixtbar.prototype.initialize.call(this, {
                        template: _.template(template),
                        tabs: [{
                                caption: me.textTabFile,
                                action: 'file',
                                extcls: 'canedit',
                                haspanel: false
                            },
                            {
                                caption: me.textTabHome,
                                action: 'home',
                                extcls: 'canedit'
                            },
                            {
                                caption: me.textTabInsert,
                                action: 'ins',
                                extcls: 'canedit'
                            },
                            {
                                caption: me.textTabLayout,
                                action: 'layout',
                                extcls: 'canedit'
                            },
                            {
                                caption: me.textTabLinks,
                                action: 'links',
                                extcls: 'canedit'
                            }
                        ]
                    ...
                    this.btnInsertTable = new Common.UI.Button({
                        ...
                        menu: new Common.UI.Menu({
                            items: [{
                                ...
                                {
                                    caption: this.mniDrawTable,
                                    value: 'draw',
                                    checkable: true
                                },
                                {
                                    caption: this.mniEraseTable,
                                    value: 'erase',
                                    checkable: true
                                }
                            ]
                    ...
                    this.btnInsertImage = new Common.UI.Button({
                        ...
                        menu: new Common.UI.Menu({
                            items: [{
                                ...
                                {
                                    caption: this.mniImageFromStorage,
                                    value: 'storage'
                                }
                            ]
                        })
                    ...
                    this.btnColumns = new Common.UI.Button({
                        ...
                        menu: new Common.UI.Menu({
                            ...
                            items: [{
                                ...
                                {
                                    caption: this.textColumnsCustom,
                                    value: 'advanced'
                                }
                            ]
                        })
                    ...
                    this.btnPageMargins = new Common.UI.Button({
                        ...
                        menu: new Common.UI.Menu({
                            items: [{
                                ...
                                {
                                    caption: this.textPageMarginsCustom,
                                    value: 'advanced'
                                }
                            ]
                        })
                    ...
                    this.btnPageSize = new Common.UI.Button({
                        ...
                        menu: new Common.UI.Menu({
                            ...
                            items: [{
                                ...
                                {
                                    caption: this.textPageSizeCustom,
                                    value: 'advanced'
                                }
                            ]
                        })
                    ...
                    me.btnsPageBreak.forEach(function(btn) {
                        ...
                        var _menu = new Common.UI.Menu({
                            items: [{
                                ...
                                {
                                    caption: me.textInsColumnBreak,
                                    value: 'column'
                                },
                                {
                                    caption: me.textInsSectionBreak,
                                    value: 'section',
                                    menu: _menu_section_break
                                }
                            ]
                        });
