    ...
    DE.Views.DocumentHolder = Backbone.View.extend(_.extend({
        ...
        initialize: function() {
            ...
            var onHideForeignCursorLabel = function(UserId) {
                ...
                for (var i = 0; i < me.fastcoauthtips.length; i++) {
                    if (me.fastcoauthtips[i].attr('userid') == UserId) {
                        ...
                        me.fastcoauthtips[i].fadeOut(150, function() {
                            src.remove()
                        });
                ...
                if (me.api && me.mode.isEdit && !me._isDisabled && !DE.getController('LeftMenu').leftMenu.menuFile.isVisible()) {
                    var handlerDlg = function(dlg, result) {
                        if (result == 'ok') {
                            ...
                            (text !== false) ?
                            me.api.add_Hyperlink(props): me.api.change_Hyperlink(props);
                        }
            ...
            this.changeLanguageMenu = function(menu) {
                if (me._currLang.id === null || me._currLang.id === undefined) {
                    ...
                    var index = _.findIndex(menu.items, {
                        langid: me._currLang.id
                    });
            ...
            this.initEquationMenu = function() {
                ...
                switch (type) {
                    case Asc.c_oAscMathInterfaceType.Accent:
                        mnu = new Common.UI.MenuItem({
                            ...
                            equationProps: {
                                type: type,
                                callback: 'remove_AccentCharacter'
                            }
                        });
                        arr.push(mnu);
                        break;
                        ...
                        mnu = new Common.UI.MenuItem({
                            ...
                            menu: new Common.UI.Menu({
                                ...
                                items: [{
                                        ...
                                        equationProps: {
                                            type: type,
                                            callback: 'put_HideTop',
                                            value: !value.get_HideTop()
                                        }
                                    },
                                    {
                                        ...
                                        equationProps: {
                                            type: type,
                                            callback: 'put_HideBottom',
                                            value: !value.get_HideBottom()
                                        }
                                    },
                                    {
                                        ...
                                        equationProps: {
                                            type: type,
                                            callback: 'put_HideLeft',
                                            value: !value.get_HideLeft()
                                        }
                                    },
                                    {
                                        ...
                                        equationProps: {
                                            type: type,
                                            callback: 'put_HideRight',
                                            value: !value.get_HideRight()
                                        }
                                    },
                                    {
                                        ...
                                        equationProps: {
                                            type: type,
                                            callback: 'put_HideHor',
                                            value: !value.get_HideHor()
                                        }
                                    },
                                    {
                                        ...
                                        equationProps: {
                                            type: type,
                                            callback: 'put_HideVer',
                                            value: !value.get_HideVer()
                                        }
                                    },
                                    {
                                        ...
                                        equationProps: {
                                            type: type,
                                            callback: 'put_HideTopLTR',
                                            value: !value.get_HideTopLTR()
                                        }
                                    },
                                    {
                                        ...
                                        equationProps: {
                                            type: type,
                                            callback: 'put_HideTopRTL',
                                            value: !value.get_HideTopRTL()
                                        }
                                    }
                                ]
                            })
                    ...
                    case Asc.c_oAscMathInterfaceType.Bar:
                        ...
                        mnu = new Common.UI.MenuItem({
                            ...
                            equationProps: {
                                type: type,
                                callback: 'put_Pos',
                                value: (value.get_Pos() == Asc.c_oAscMathInterfaceBarPos.Top) ? Asc.c_oAscMathInterfaceBarPos.Bottom : Asc.c_oAscMathInterfaceBarPos.Top
                            }
                        });
                        arr.push(mnu);
                        break;
                    case Asc.c_oAscMathInterfaceType.Script:
                        ...
                        if (scripttype == Asc.c_oAscMathInterfaceScript.PreSubSup) {
                            mnu = new Common.UI.MenuItem({
                                ...
                                equationProps: {
                                    type: type,
                                    callback: 'put_ScriptType',
                                    value: Asc.c_oAscMathInterfaceScript.SubSup
                                }
                            });
                            arr.push(mnu);
                            mnu = new Common.UI.MenuItem({
                                ...
                                equationProps: {
                                    type: type,
                                    callback: 'put_ScriptType',
                                    value: Asc.c_oAscMathInterfaceScript.None
                                }
                            });
                            arr.push(mnu);
                        } else {
                            if (scripttype == Asc.c_oAscMathInterfaceScript.SubSup) {
                                mnu = new Common.UI.MenuItem({
                                    ...
                                    equationProps: {
                                        type: type,
                                        callback: 'put_ScriptType',
                                        value: Asc.c_oAscMathInterfaceScript.PreSubSup
                                    }
                                });
                                arr.push(mnu);
                            }
                            if (scripttype == Asc.c_oAscMathInterfaceScript.SubSup || scripttype == Asc.c_oAscMathInterfaceScript.Sub) {
                                mnu = new Common.UI.MenuItem({
                                    ...
                                    equationProps: {
                                        type: type,
                                        callback: 'put_ScriptType',
                                        value: (scripttype == Asc.c_oAscMathInterfaceScript.SubSup) ? Asc.c_oAscMathInterfaceScript.Sup : Asc.c_oAscMathInterfaceScript.None
                                    }
                                });
                                arr.push(mnu);
                            }
                            if (scripttype == Asc.c_oAscMathInterfaceScript.SubSup || scripttype == Asc.c_oAscMathInterfaceScript.Sup) {
                                mnu = new Common.UI.MenuItem({
                                    ...
                                    equationProps: {
                                        type: type,
                                        callback: 'put_ScriptType',
                                        value: (scripttype == Asc.c_oAscMathInterfaceScript.SubSup) ? Asc.c_oAscMathInterfaceScript.Sub : Asc.c_oAscMathInterfaceScript.None
                                    }
                                });
                                arr.push(mnu);
                            }
                    ...
                    case Asc.c_oAscMathInterfaceType.Fraction:
                        ...
                        if (fraction == Asc.c_oAscMathInterfaceFraction.Skewed || fraction == Asc.c_oAscMathInterfaceFraction.Linear) {
                            mnu = new Common.UI.MenuItem({
                                ...
                                equationProps: {
                                    type: type,
                                    callback: 'put_FractionType',
                                    value: Asc.c_oAscMathInterfaceFraction.Bar
                                }
                            });
                            arr.push(mnu);
                        }
                        if (fraction == Asc.c_oAscMathInterfaceFraction.Bar || fraction == Asc.c_oAscMathInterfaceFraction.Linear) {
                            mnu = new Common.UI.MenuItem({
                                ...
                                equationProps: {
                                    type: type,
                                    callback: 'put_FractionType',
                                    value: Asc.c_oAscMathInterfaceFraction.Skewed
                                }
                            });
                            arr.push(mnu);
                        }
                        if (fraction == Asc.c_oAscMathInterfaceFraction.Bar || fraction == Asc.c_oAscMathInterfaceFraction.Skewed) {
                            mnu = new Common.UI.MenuItem({
                                ...
                                equationProps: {
                                    type: type,
                                    callback: 'put_FractionType',
                                    value: Asc.c_oAscMathInterfaceFraction.Linear
                                }
                            });
                            arr.push(mnu);
                        }
                        if (fraction == Asc.c_oAscMathInterfaceFraction.Bar || fraction == Asc.c_oAscMathInterfaceFraction.NoBar) {
                            mnu = new Common.UI.MenuItem({
                                ...
                                equationProps: {
                                    type: type,
                                    callback: 'put_FractionType',
                                    value: (fraction == Asc.c_oAscMathInterfaceFraction.Bar) ? Asc.c_oAscMathInterfaceFraction.NoBar : Asc.c_oAscMathInterfaceFraction.Bar
                                }
                            });
                            arr.push(mnu);
                        }
                    ...
                    case Asc.c_oAscMathInterfaceType.Limit:
                        mnu = new Common.UI.MenuItem({
                            ...
                            equationProps: {
                                type: type,
                                callback: 'put_Pos',
                                value: (value.get_Pos() == Asc.c_oAscMathInterfaceLimitPos.Top) ? Asc.c_oAscMathInterfaceLimitPos.Bottom : Asc.c_oAscMathInterfaceLimitPos.Top
                            }
                        });
                        arr.push(mnu);
                        mnu = new Common.UI.MenuItem({
                            ...
                            equationProps: {
                                type: type,
                                callback: 'put_Pos',
                                value: Asc.c_oAscMathInterfaceLimitPos.None
                            }
                        });
                        arr.push(mnu);
                        break;
                    case Asc.c_oAscMathInterfaceType.Matrix:
                        mnu = new Common.UI.MenuItem({
                            ...
                            equationProps: {
                                type: type,
                                callback: 'put_HidePlaceholder',
                                value: !value.get_HidePlaceholder()
                            }
                        });
                        arr.push(mnu);
                        mnu = new Common.UI.MenuItem({
                        ...
                        mnu = new Common.UI.MenuItem({
                            ...
                            menu: new Common.UI.Menu({
                                ...
                                items: [{
                                        ...
                                        equationProps: {
                                            type: type,
                                            callback: 'put_MatrixAlign',
                                            value: Asc.c_oAscMathInterfaceMatrixMatrixAlign.Top
                                        }
                                    },
                                    {
                                        ...
                                        equationProps: {
                                            type: type,
                                            callback: 'put_MatrixAlign',
                                            value: Asc.c_oAscMathInterfaceMatrixMatrixAlign.Center
                                        }
                                    },
                                    {
                                        ...
                                        equationProps: {
                                            type: type,
                                            callback: 'put_MatrixAlign',
                                            value: Asc.c_oAscMathInterfaceMatrixMatrixAlign.Bottom
                                        }
                                    }
                                ]
                            })
                        ...
                        mnu = new Common.UI.MenuItem({
                            ...
                            menu: new Common.UI.Menu({
                                ...
                                items: [{
                                        ...
                                        equationProps: {
                                            type: type,
                                            callback: 'put_ColumnAlign',
                                            value: Asc.c_oAscMathInterfaceMatrixColumnAlign.Left
                                        }
                                    },
                                    {
                                        caption: me.centerText,
                                        ...
                                        equationProps: {
                                            type: type,
                                            callback: 'put_ColumnAlign',
                                            value: Asc.c_oAscMathInterfaceMatrixColumnAlign.Center
                                        }
                                    },
                                    {
                                        ...
                                        equationProps: {
                                            type: type,
                                            callback: 'put_ColumnAlign',
                                            value: Asc.c_oAscMathInterfaceMatrixColumnAlign.Right
                                        }
                                    }
                                ]
                            })
                            ...
                            menu: new Common.UI.Menu({
                                ...
                                items: [{
                                        ...
                                        equationProps: {
                                            type: type,
                                            callback: 'put_Align',
                                            value: Asc.c_oAscMathInterfaceEqArrayAlign.Top
                                        }
                                    },
                                    {
                                        caption: me.centerText,
                                        ...
                                        equationProps: {
                                            type: type,
                                            callback: 'put_Align',
                                            value: Asc.c_oAscMathInterfaceEqArrayAlign.Center
                                        }
                                    },
                                    {
                                        caption: me.txtBottom,
                                        ...
                                        equationProps: {
                                            type: type,
                                            callback: 'put_Align',
                                            value: Asc.c_oAscMathInterfaceEqArrayAlign.Bottom
                                        }
                                    }
                                ]
                            })
                    ...
                    case Asc.c_oAscMathInterfaceType.LargeOperator:
                        mnu = new Common.UI.MenuItem({
                            ...
                            equationProps: {
                                type: type,
                                callback: 'put_LimitLocation',
                                value: (value.get_LimitLocation() == Asc.c_oAscMathInterfaceNaryLimitLocation.UndOvr) ? Asc.c_oAscMathInterfaceNaryLimitLocation.SubSup : Asc.c_oAscMathInterfaceNaryLimitLocation.UndOvr
                            }
                        });
                        arr.push(mnu);
                        if (value.get_HideUpper() !== undefined) {
                            mnu = new Common.UI.MenuItem({
                                ...
                                equationProps: {
                                    type: type,
                                    callback: 'put_HideUpper',
                                    value: !value.get_HideUpper()
                                }
                            });
                            arr.push(mnu);
                        }
                        if (value.get_HideLower() !== undefined) {
                            mnu = new Common.UI.MenuItem({
                                ...
                                equationProps: {
                                    type: type,
                                    callback: 'put_HideLower',
                                    value: !value.get_HideLower()
                                }
                            });
                            arr.push(mnu);
                        }
                    ...
                    case Asc.c_oAscMathInterfaceType.Delimiter:
                        mnu = new Common.UI.MenuItem({
                            ...
                            equationProps: {
                                type: type,
                                callback: 'insert_DelimiterArgument',
                                value: true
                            }
                        });
                        arr.push(mnu);
                        ...
                        if (value.can_DeleteArgument()) {
                            mnu = new Common.UI.MenuItem({
                                ...
                                equationProps: {
                                    type: type,
                                    callback: 'delete_DelimiterArgument'
                                }
                            });
                            arr.push(mnu);
                        }
                        mnu = new Common.UI.MenuItem({
                            ...
                            equationProps: {
                                type: type,
                                callback: 'remove_DelimiterCharacters'
                            }
                        });
                        arr.push(mnu);
                        mnu = new Common.UI.MenuItem({
                            ...
                            equationProps: {
                                type: type,
                                callback: 'put_HideOpeningBracket',
                                value: !value.get_HideOpeningBracket()
                            }
                        });
                        arr.push(mnu);
                        mnu = new Common.UI.MenuItem({
                            ...
                            equationProps: {
                                type: type,
                                callback: 'put_HideClosingBracket',
                                value: !value.get_HideClosingBracket()
                            }
                        });
                        arr.push(mnu);
                        mnu = new Common.UI.MenuItem({
                            ...
                            equationProps: {
                                type: type,
                                callback: 'put_StretchBrackets',
                                value: !value.get_StretchBrackets()
                            }
                        });
                        arr.push(mnu);
                        mnu = new Common.UI.MenuItem({
                            ...
                            equationProps: {
                                type: type,
                                callback: 'put_MatchBrackets',
                                value: !value.get_MatchBrackets()
                            }
                        });
                        arr.push(mnu);
                        break;
                        ...
                        if (value.can_ChangePos()) {
                            mnu = new Common.UI.MenuItem({
                                ...
                                equationProps: {
                                    type: type,
                                    callback: 'put_Pos',
                                    value: (value.get_Pos() == Asc.c_oAscMathInterfaceGroupCharPos.Top) ? Asc.c_oAscMathInterfaceGroupCharPos.Bottom : Asc.c_oAscMathInterfaceGroupCharPos.Top
                                }
                            });
                            arr.push(mnu);
                            mnu = new Common.UI.MenuItem({
                                ...
                                equationProps: {
                                    type: type,
                                    callback: 'put_Pos',
                                    value: Asc.c_oAscMathInterfaceGroupCharPos.None
                                }
                            });
                            arr.push(mnu);
                        }
                    ...
                    case Asc.c_oAscMathInterfaceType.Radical:
                        if (value.get_HideDegree() !== undefined) {
                            mnu = new Common.UI.MenuItem({
                                ...
                                equationProps: {
                                    type: type,
                                    callback: 'put_HideDegree',
                                    value: !value.get_HideDegree()
                                }
                            });
                            arr.push(mnu);
                        }
                ...
                if (value.can_IncreaseArgumentSize()) {
                    mnu = new Common.UI.MenuItem({
                        ...
                        equationProps: {
                            type: type,
                            callback: 'increase_ArgumentSize'
                        }
                    });
                    arr.push(mnu);
                }
                if (value.can_DecreaseArgumentSize()) {
                    mnu = new Common.UI.MenuItem({
                        ...
                        equationProps: {
                            type: type,
                            callback: 'decrease_ArgumentSize'
                        }
                    });
                    arr.push(mnu);
                }
            ...
            this.setMode = function(m) {
                ...
                Common.util.Shortcuts.suspendEvents(hkComments): Common.util.Shortcuts.resumeEvents(hkComments);
                /** coauthoring end **/
                this.editorConfig = {
                    user: m.user
                };
        ...
        onRulerDblClick: function(type) {
            ...
            if (type == 'tables') {
                ...
                win = this.advancedParagraphClick({
                    isChart: false
                });
                if (win)
        ...
        createDelayedElementsViewer: function() {
            ...
            var menuSignatureViewSign = new Common.UI.MenuItem({
                caption: this.strSign,
                value: 0
            }).on('click', _.bind(me.onSignatureClick, me));
            var menuSignatureDetails = new Common.UI.MenuItem({
                caption: this.strDetails,
                value: 1
            }).on('click', _.bind(me.onSignatureClick, me));
            var menuSignatureViewSetup = new Common.UI.MenuItem({
                caption: this.strSetup,
                value: 2
            }).on('click', _.bind(me.onSignatureClick, me));
            var menuSignatureRemove = new Common.UI.MenuItem({
                caption: this.strDelete,
                value: 3
            }).on('click', _.bind(me.onSignatureClick, me));
            var menuViewSignSeparator = new Common.UI.MenuItem({
                caption: '--'
            });
        ...
        createDelayedElements: function() {
            ...
            var menuInsertCaptionSeparator = new Common.UI.MenuItem({
                caption: '--'
            });
            ...
            var menuEquationInsertCaptionSeparator = new Common.UI.MenuItem({
                caption: '--'
            });
            ...
            var menuSignatureEditSign = new Common.UI.MenuItem({
                caption: this.strSign,
                value: 0
            }).on('click', _.bind(me.onSignatureClick, me));
            var menuSignatureEditSetup = new Common.UI.MenuItem({
                caption: this.strSetup,
                value: 2
            }).on('click', _.bind(me.onSignatureClick, me));
            var menuEditSignSeparator = new Common.UI.MenuItem({
                caption: '--'
            });
            ...
            this.tableMenu = new Common.UI.Menu({
                initMenu: function(value) {
                    ...
                    if (in_list) {
                        ...
                        menuTableStartNewList.value = {
                            start: numLvl.get_Start()
                        };
                        menuTableStartNumberingFrom.setVisible(format != Asc.c_oAscNumberingFormat.Bullet);
                        menuTableStartNumberingFrom.value = {
                            format: format,
                            start: start
                        };
