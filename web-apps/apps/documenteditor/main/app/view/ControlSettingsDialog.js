    ...
    DE.Views.ControlSettingsDialog = Common.Views.AdvancedSettingsWindow.extend(_.extend({
        ...
        initialize: function(options) {
            ...
            _.extend(this.options, {
                ...
                items: [{
                        panelId: 'id-adv-control-settings-general',
                        panelCaption: this.strGeneral
                    },
                    {
                        panelId: 'id-adv-control-settings-lock',
                        panelCaption: this.textLock
                    },
                    {
                        panelId: 'id-adv-control-settings-list',
                        panelCaption: this.textCombobox
                    },
                    {
                        panelId: 'id-adv-control-settings-date',
                        panelCaption: this.textDate
                    },
                    {
                        panelId: 'id-adv-control-settings-checkbox',
                        panelCaption: this.textCheckbox
                    }
                ],
        ...
        render: function() {
            ...
            this.cmbShow = new Common.UI.ComboBox({
                ...
                data: [{
                        ...
                        value: Asc.c_oAscSdtAppearance.Frame
                    },
                    {
                        displayValue: this.textNone,
                        value: Asc.c_oAscSdtAppearance.Hidden
                    }
                ]
            });
            ...
            this.btnEditUnchecked.cmpEl.css({
                'font-size': '16px',
                'line-height': '16px'
            });
            ...
            if (props) {
                ...
                if (type == Asc.c_oAscContentControlSpecificType.DateTime) {
                    ...
                    if (specProps) {
                        ...
                        if (lang) {
                            var item = this.cmbLang.store.findWhere({
                                value: lang
                            });
                        ...
                        var rec = this.listFormats.store.findWhere({
                            format: format
                        });
        ...
        onMoveItem: function(up) {
            ...
            if (rec) {
                ...
                store.add(store.remove(rec), {
                    at: up ? Math.max(0, index - 1) : Math.min(length - 1, index + 1)
                });
