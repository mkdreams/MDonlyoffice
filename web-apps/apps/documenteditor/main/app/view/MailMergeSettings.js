...
define([
    ...
    DE.Views.MailMergeSettings = Backbone.View.extend(_.extend({
        ...
        createDelayedControls: function() {
            ...
            this._arrMergeSrc = [{
                    displayValue: this.textPdf,
                    value: Asc.c_oAscFileType.PDF
                },
                {
                    displayValue: this.textDocx,
                    value: Asc.c_oAscFileType.DOCX
                },
                {
                    displayValue: this.textEmail,
                    value: Asc.c_oAscFileType.HTML
                }
            ];
        ...
        onRadioFromToChange: function(field, newValue, eOpts) {
            if (newValue) {
                this.lockControls(DE.enumLockMM.radioAllCurr, false, {
                    array: [this.txtFieldFrom, this.txtFieldTo]
                });
            }
        },
        ...
        onRadioAllCurrent: function(field, newValue, eOpts) {
            if (newValue) {
                this.lockControls(DE.enumLockMM.radioAllCurr, true, {
                    array: [this.txtFieldFrom, this.txtFieldTo]
                });
            }
        },
        ...
        onDownloadClick: function(type, btn, e) {
            if (this.api) {
                var from = 0,
                    to = Math.min(Math.max(this._state.recipientsCount - 1, 0), 99);
        ...
        disableInsertControls: function(disable) {
            this.lockControls(DE.enumLockMM.coAuth, disable, {
                array: [this.btnInsField]
            });
        },
        ...
        disableEditing: function(disable) {
            ...
            this.lockControls(DE.enumLockMM.preview, disable, {
                array: [this.btnInsField, this.btnEditData]
            });
        },
