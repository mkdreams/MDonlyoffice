    ...
    DE.Views.PageSizeDialog = Common.UI.Window.extend(_.extend({
        ...
        render: function() {
            ...
            this.cmbPreset = new Common.UI.ComboBox({
                ...
                data: [{
                        value: 0,
                        displayValue: 'US Letter',
                        size: [215.9, 279.4]
                    },
                    {
                        value: 1,
                        displayValue: 'US Legal',
                        size: [215.9, 355.6]
                    },
                    {
                        value: 2,
                    ...
                    {
                        value: 5,
                        displayValue: 'Envelope #10',
                        size: [104.8, 241.3]
                    },
                    {
                        value: 6,
                        displayValue: 'Envelope DL',
                        size: [110, 220]
                    },
                    {
                        value: 7,
                    ...
                    {
                        value: 9,
                        displayValue: 'Tabloid Oversize',
                        size: [304.8, 457.1]
                    },
                    {
                        value: 10,
                        displayValue: 'ROC 16K',
                        size: [196.8, 273]
                    },
                    {
                        value: 11,
                        displayValue: 'Envelope Choukei 3',
                        size: [119.9, 234.9]
                    },
                    {
                        value: 12,
                        displayValue: 'Super B/A3',
                        size: [330.2, 482.5]
                    },
                    {
                        value: 13,
