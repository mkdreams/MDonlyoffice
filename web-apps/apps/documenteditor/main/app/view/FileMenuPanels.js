...
define([
    ...
    DE.Views.FileMenuPanels.ViewSaveAs = Common.UI.BaseView.extend({
        ...
        formats: [
            [{
                    name: 'DOCX',
                    imgCls: 'docx',
                    type: Asc.c_oAscFileType.DOCX
                },
                {
                    name: 'PDF',
                    imgCls: 'pdf',
                    type: Asc.c_oAscFileType.PDF
                },
                {
                    name: 'ODT',
                    imgCls: 'odt',
                    type: Asc.c_oAscFileType.ODT
                },
                {
                    name: 'TXT',
                    imgCls: 'txt',
                    type: Asc.c_oAscFileType.TXT
                }
            ],
            [{
                    name: 'DOTX',
                    imgCls: 'dotx',
                    type: Asc.c_oAscFileType.DOTX
                },
                {
                    name: 'PDFA',
                    imgCls: 'pdfa',
                    type: Asc.c_oAscFileType.PDFA
                },
                {
                    name: 'OTT',
                    imgCls: 'ott',
                    type: Asc.c_oAscFileType.OTT
                },
                {
                    name: 'RTF',
                    imgCls: 'rtf',
                    type: Asc.c_oAscFileType.RTF
                }
            ],
            [{
                name: 'HTML (Zipped)',
                imgCls: 'html',
                type: Asc.c_oAscFileType.HTML
            }]
        ],
    ...
    DE.Views.FileMenuPanels.Settings = Common.UI.BaseView.extend(_.extend({
        ...
        render: function(node) {
            ...
            this.cmbZoom = new Common.UI.ComboBox({
                ...
                data: [{
                        value: -1,
                        displayValue: this.txtFitPage
                    },
                    {
                        value: -2,
                        displayValue: this.txtFitWidth
                    },
                    {
                        value: 50,
                        displayValue: "50%"
            ...
            this.cmbCoAuthMode = new Common.UI.ComboBox({
                ...
                data: [{
                        value: 1,
                        displayValue: this.strFast,
                        descValue: this.strCoAuthModeDescFast
                    },
                    {
                        value: 0,
                        displayValue: this.strStrict,
                        descValue: this.strCoAuthModeDescStrict
                    }
                ]
            ...
            this.cmbFontRender = new Common.UI.ComboBox({
                ...
                data: [{
                    ...
                    {
                        value: 'custom',
                        displayValue: this.txtCacheMode
                    }
                ]
            });
        ...
        updateSettings: function() {
            ...
            item = this.cmbCoAuthMode.store.findWhere({
                value: fast_coauth ? 1 : 0
            });
        ...
        applySettings: function() {
            ...
            var item = this.cmbFontRender.store.findWhere({
                value: 'custom'
            });
    ...
    DE.Views.FileMenuPanels.DocumentInfo = Common.UI.BaseView.extend(_.extend({
        ...
        updateInfo: function(doc) {
            ...
            if (this.coreProps) {
                ...
                if (value)
                    this.lblDate.text(value.toLocaleString(this.mode.lang, {
                        year: 'numeric',
                        month: '2-digit',
                        day: '2-digit'
                    }) + ' ' + value.toLocaleString(this.mode.lang, {
                        timeStyle: 'short'
                    }));
        ...
        updateFileInfo: function() {
            ...
            if (props) {
                ...
                if (value)
                    this.lblModifyDate.text(value.toLocaleString(this.mode.lang, {
                        year: 'numeric',
                        month: '2-digit',
                        day: '2-digit'
                    }) + ' ' + value.toLocaleString(this.mode.lang, {
    ...
    DE.Views.FileMenuPanels.DocumentRights = Common.UI.BaseView.extend(_.extend({
        ...
        updateSharingSettings: function(rights) {
            ...
            this.cntRights.html(this.templateRights({
                users: this.doc.info.sharingSettings
            }));
        },
    ...
    DE.Views.FileMenuPanels.Help = Common.UI.BaseView.extend({
        ...
        initialize: function(options) {
            ...
            this.en_data = [{
                    ...
                    "name": "Introducing Document Editor user interface",
                    "headername": "Program Interface"
                },
                {
                ...
                },
                {
                    ...
                    "name": "Align your text in a paragraph",
                    "headername": "Paragraph formatting"
                },
                {
                ...
                },
                {
                    ...
                    "name": "Apply formatting styles",
                    "headername": "Text formatting"
                },
                {
                ...
                },
                {
                    ...
                    "name": "Insert a drop cap"
                },
                {
                    "src": "UsageInstructions/InsertTables.htm",
                    "name": "Insert tables",
                    "headername": "Operations on objects"
                },
                {
                ...
                },
                {
                    ...
                    "headername": "Tools and settings"
                },
                {
                    "src": "UsageInstructions/SavePrintDownload.htm",
                    "name": "Save/download/print your document"
                },
                {
                    "src": "HelpfulHints/AdvancedSettings.htm",
                    "name": "Advanced settings of Document Editor"
                },
                {
                    "src": "HelpfulHints/Navigation.htm",
                    "name": "View settings and navigation tools"
                },
                {
        ...
        setLangConfig: function(lang) {
            ...
            if (lang) {
                ...
                var config = {
                    ...
                    success: function() {
                        var rec = (me.openUrl) ? store.findWhere({
                            src: me.openUrl
                        }) || store.at(0) : store.at(0);
    ...
    DE.Views.FileMenuPanels.ProtectDoc = Common.UI.BaseView.extend(_.extend({
        ...
        updateSignatures: function() {
            ...
            this.cntSignatureView.html(this.templateSignature({
                tipText: tipText,
                hasSigned: (hasValid || hasInvalid),
