...
define([
    ...
    DE.Views.ListSettingsDialog = Common.UI.Window.extend(_.extend({
        ...
        render: function() {
            ...
            this.cmbFormat = new Common.UI.ComboBoxCustom({
                ...
                data: [{
                        ...
                        value: Asc.c_oAscNumberingFormat.None
                    },
                    {
                        displayValue: '1, 2, 3,...',
                    ...
                    if (record.value == -1) {
                        var callback = function(result) {
                            ...
                            if (format == Asc.c_oAscNumberingFormat.Bullet) {
                                ...
                                if (!store.findWhere({
                                        value: Asc.c_oAscNumberingFormat.Bullet,
                                        symbol: me.bulletProps.symbol,
                                        font: me.bulletProps.font
                                    }))
                                    store.add({
                                        displayValue: me.txtSymbol + ': ',
                                        value: Asc.c_oAscNumberingFormat.Bullet,
                                        symbol: me.bulletProps.symbol,
                                        font: me.bulletProps.font
                                    }, {
                                ...
                                combo.selectRecord(combo.store.findWhere({
                                    value: Asc.c_oAscNumberingFormat.Bullet,
                                    symbol: me.bulletProps.symbol,
                                    font: me.bulletProps.font
                                }));
        ...
        _handleInput: function(state) {
            if (this.options.handler) {
                ...
                this.options.handler.call(this, state, {
                    props: (props.length == 1) ? props[0] : props,
                    num: (lvlnum.length == 1) ? lvlnum[0] : lvlnum
                });
            }
            this.close();
        },
            ...
            if (props) {
                ...
                if (this.type == 2) {
                    ...
                    store.push([{
                        ...
                        {
                            displayValue: this.txtNewBullet,
                            value: -1
                        }
                    ]);
        ...
        fillLevelProps: function(levelProps) {
            ...
            if (this.type > 0) {
                if (format == Asc.c_oAscNumberingFormat.Bullet) {
                    if (!this.cmbFormat.store.findWhere({
                            value: Asc.c_oAscNumberingFormat.Bullet,
                            symbol: this.bulletProps.symbol,
                            font: this.bulletProps.font
                        }))
                        this.cmbFormat.store.add({
                            displayValue: this.txtSymbol + ': ',
                            value: Asc.c_oAscNumberingFormat.Bullet,
                            symbol: this.bulletProps.symbol,
                            font: this.bulletProps.font
                        }, {
                            at: this.cmbFormat.store.length - 1
                        });
                    this.cmbFormat.setData(this.cmbFormat.store.models);
                    this.cmbFormat.selectRecord(this.cmbFormat.store.findWhere({
                        value: Asc.c_oAscNumberingFormat.Bullet,
                        symbol: this.bulletProps.symbol,
                        font: this.bulletProps.font
                    }));
