    ...
    DE.Views.CaptionDialog = Common.Views.AdvancedSettingsWindow.extend(_.extend({
        ...
        render: function() {
            ...
            this.cmbPosition = new Common.UI.ComboBox({
                ...
                data: [{
                        displayValue: this.textBefore,
                        value: 1
                    },
                    {
                        displayValue: this.textAfter,
                        value: 0
                    }
                ]
            });
            ...
            this.arrLabel = arr.concat([{
                    displayValue: this.textEquation,
                    value: this.textEquation,
                    type: 0
                },
                {
                    displayValue: this.textFigure,
                    value: this.textFigure,
                    type: 0
                },
                {
                    displayValue: this.textTable,
                    value: this.textTable,
                    type: 0
                }
            ]);
            ...
            this.btnAdd.on('click', _.bind(function(e) {
                ...
                (new DE.Views.AddNewCaptionLabelDialog({
                    handler: function(result, value) {
                        if (result == 'ok') {
                            var rec = _.findWhere(me.arrLabel, {
                                value: value
                            });
                            if (rec) {
            ...
            for (var i = 0; i < 9; i++) {
                this._arrLevel.push({
                    displayValue: _main['txtStyle_Heading_' + (i + 1)],
                    value: i
                });
            }
            ...
            this.cmbSeparator = new Common.UI.ComboBox({
                ...
                disabled: true,
                data: [{
                        displayValue: '-     (' + this.textHyphen + ')',
                        value: '-'
                    },
                    {
                        displayValue: '.     (' + this.textPeriod + ')',
                        value: '.'
                    },
                    {
                        displayValue: ':     (' + this.textColon + ')',
                        value: ':'
                    },
                    {
                        displayValue: '—  (' + this.textLongDash + ')',
                        value: '—'
                    },
                    {
                        displayValue: '–    (' + this.textDash + ')',
                        value: '–'
                    }
                ]
            });
