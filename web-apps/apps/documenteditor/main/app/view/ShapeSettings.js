    ...
    DE.Views.ShapeSettings = Backbone.View.extend(_.extend({
        ...
        createDelayedControls: function() {
            ...
            this._arrFillSrc = [{
                    ...
                    value: Asc.c_oAscFill.FILL_TYPE_SOLID
                },
                {
                ...
                },
                {
                    ...
                    value: Asc.c_oAscFill.FILL_TYPE_BLIP
                },
                {
                    displayValue: this.textPatternFill,
                    value: Asc.c_oAscFill.FILL_TYPE_PATT
                },
                {
                    displayValue: this.textNoFill,
                    value: Asc.c_oAscFill.FILL_TYPE_NOFILL
                }
            ];
            ...
            this._arrFillType = [{
                    ...
                    value: Asc.c_oAscFillBlipType.STRETCH
                },
                {
                    displayValue: this.textTile,
                    value: Asc.c_oAscFillBlipType.TILE
                }
            ];
            ...
            this._arrGradType = [{
                    ...
                    value: Asc.c_oAscFillGradType.GRAD_LINEAR
                },
                {
                    displayValue: this.textRadial,
                    value: Asc.c_oAscFillGradType.GRAD_PATH
                }
            ];
            ...
            var viewData = [{
                ...
                {
                    offsetx: 50,
                    data: Asc.c_oAscWrapStyle2.Square,
                    tip: this.txtSquare
                },
                {
                    offsetx: 100,
                    data: Asc.c_oAscWrapStyle2.Tight,
                    tip: this.txtTight
                },
                {
                    offsetx: 150,
                ...
                {
                    offsetx: 250,
                    data: Asc.c_oAscWrapStyle2.InFront,
                    tip: this.txtInFront
                },
                {
                    offsetx: 300,
                    data: Asc.c_oAscWrapStyle2.Behind,
                    tip: this.txtBehind
                }
            ];
            ...
            this.cmbWrapType.openButton.menu.on('show:after', function() {
                me.cmbWrapType.menuPicker.scroller.update({
                    alwaysVisibleY: true
                });
            });
