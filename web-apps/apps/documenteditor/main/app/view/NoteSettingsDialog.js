    ...
    DE.Views.NoteSettingsDialog = Common.Views.AdvancedSettingsWindow.extend(_.extend({
        ...
        render: function() {
            ...
            this.cmbFootnote = new Common.UI.ComboBox({
                ...
                editable: false,
                data: [{
                        displayValue: this.textPageBottom,
                        value: Asc.c_oAscFootnotePos.PageBottom
                    },
                    {
                        displayValue: this.textTextBottom,
                        value: Asc.c_oAscFootnotePos.BeneathText
                    }
                ]
            });
            ...
            this.cmbNumbering = new Common.UI.ComboBox({
                ...
                editable: false,
                data: [{
                        displayValue: this.textContinue,
                        value: Asc.c_oAscFootnoteRestart.Continuous
                    },
                    {
                        displayValue: this.textEachSection,
                        value: Asc.c_oAscFootnoteRestart.EachSect
                    },
                    {
                        displayValue: this.textEachPage,
                        value: Asc.c_oAscFootnoteRestart.EachPage
                    }
                ]
            });
        ...
        getSettings: function() {
            ...
            return {
                props: props,
                applyToAll: (this.cmbApply.getValue() == 1),
                custom: _.isEmpty(val) ? undefined : val
            };
        },
        ...
        onFormatSelect: function(combo, record) {
            ...
            switch (record.value) {
                ...
                case Asc.c_oAscNumberingFormat.LowerRoman: // i, ii, iii, ...
                    this.spnStart.options.toCustomFormat = function(value) {
                        return me._10toRome(value).toLocaleLowerCase();
                    };
                    this.spnStart.options.fromCustomFormat = function(value) {
                        return me._Rometo10(value.toLocaleUpperCase());
                    };
                    break;
                ...
                case Asc.c_oAscNumberingFormat.LowerLetter: // a, b, c, ...
                    this.spnStart.options.toCustomFormat = function(value) {
                        return me._10toS(value).toLocaleLowerCase();
                    };
                    this.spnStart.options.fromCustomFormat = function(value) {
                        return me._Sto10(value.toLocaleUpperCase());
                    };
                    break;
                default: // 1, 2, 3, ...
                    this.spnStart.options.toCustomFormat = function(value) {
