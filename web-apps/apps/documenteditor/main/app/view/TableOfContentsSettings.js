    ...
    DE.Views.TableOfContentsSettings = Common.Views.AdvancedSettingsWindow.extend(_.extend({
        ...
        render: function() {
            ...
            this.radioStyles.on('change', _.bind(function(field, newValue, eOpts) {
                if (newValue) {
                    ...
                    this.stylesList.scroller.update({
                        alwaysVisibleY: true
                    });
                    setTimeout(function() {
                        var rec = me.stylesLevels.findWhere({
                            checked: true
                        });
                        if (rec)
            ...
            this.cmbStyles = new Common.UI.ComboBox({
                ...
                editable: false,
                data: [{
                        displayValue: this.txtCurrent,
                        value: Asc.c_oAscTOCStylesType.Current
                    },
                    {
                        displayValue: this.txtSimple,
                        value: Asc.c_oAscTOCStylesType.Simple
                    },
                    {
                        displayValue: this.txtOnline,
                        value: Asc.c_oAscTOCStylesType.Web
                    },
                    {
                        displayValue: this.txtStandard,
                        value: Asc.c_oAscTOCStylesType.Standard
                    },
                    {
                        displayValue: this.txtModern,
                        value: Asc.c_oAscTOCStylesType.Modern
                    },
                    {
                        displayValue: this.txtClassic,
                        value: Asc.c_oAscTOCStylesType.Classic
                    }
                ]
            });
        ...
        _setDefaults: function(props) {
            ...
            if (checkStyles) {
                ...
                var rec = this.stylesLevels.findWhere({
                    checked: true
                });
                if (rec)
        ...
        synchronizeLevelsFromOutline: function() {
            var start = 1,
                end = this.spnLevels.getNumberValue();
