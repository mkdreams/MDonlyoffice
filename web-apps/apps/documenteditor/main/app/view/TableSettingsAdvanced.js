    ...
    DE.Views.TableSettingsAdvanced = Common.Views.AdvancedSettingsWindow.extend(_.extend({
        ...
        initialize: function(options) {
            _.extend(this.options, {
                ...
                items: [{
                    ...
                    },
                    {
                        ...
                        panelCaption: this.textTablePosition
                    },
                    {
            ...
            this.TableColor = {
                Value: 1,
                Color: 'transparent'
            }; // value=1 - цвет определен - прозрачный или другой
            this.CellColor = {
                Value: 1,
                Color: 'transparent'
        ...
        render: function() {
            ...
            this.cmbUnit = new Common.UI.ComboBox({
                ...
                data: [{
                        value: 0,
                        displayValue: (currmetric == Common.Utils.Metric.c_MetricUnits.pt) ? this.txtPt : ((currmetric == Common.Utils.Metric.c_MetricUnits.inch) ? this.txtInch : this.txtCm)
                    },
                    {
                        value: 1,
                        displayValue: this.txtPercent
                    }
                ]
            });
            ...
            this._arrHAlign = [{
                    ...
                    value: Asc.c_oAscXAlign.Left
                },
                {
                    displayValue: this.textCenter,
                    value: Asc.c_oAscXAlign.Center
                },
                {
                    displayValue: this.textRight,
                    value: Asc.c_oAscXAlign.Right
                }
            ];
            ...
            this._arrHRelative = [{
                    ...
                    value: Asc.c_oAscHAnchor.Margin
                },
                {
                    displayValue: this.textPage,
                    value: Asc.c_oAscHAnchor.Page
                },
                {
                    displayValue: this.textAnchorText,
                    value: Asc.c_oAscHAnchor.Text
                }
            ];
            ...
            this._arrVAlign = [{
                    ...
                    value: Asc.c_oAscYAlign.Top
                },
                {
                    displayValue: this.textCenter,
                    value: Asc.c_oAscYAlign.Center
                },
                {
                    displayValue: this.textBottom,
                    value: Asc.c_oAscYAlign.Bottom
                }
            ];
            ...
            this._arrVRelative = [{
                    displayValue: this.textMargin,
                    value: Asc.c_oAscVAnchor.Margin
                },
                {
                    displayValue: this.textPage,
                    value: Asc.c_oAscVAnchor.Page
                },
                {
                    displayValue: this.textAnchorText,
                    value: Asc.c_oAscVAnchor.Text
                }
            ];
