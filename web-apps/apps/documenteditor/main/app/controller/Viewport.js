...
define([
    ...
    DE.Controllers.Viewport = Backbone.Controller.extend(_.assign({
        ...
        onLayoutChanged: function(area) {
            switch (area) {
                default: this.viewport.vlayout.doLayout();
                case 'rightmenu':
        ...
        onOptionsItemClick: function(menu, item, e) {
            ...
            switch (item.value) {
                case 'toolbar':
                    me.header.fireEvent('toolbar:setcompact', [menu, item.isChecked()]);
                    break;
                case 'statusbar':
                    me.header.fireEvent('statusbar:hide', [item, item.isChecked()]);
                    break;
                case 'rulers':
                ...
                case 'zoom:width':
                    ...
                    break;
                case 'advanced':
                    me.header.fireEvent('file:settings', me.header);
                    break;
            }
        },
