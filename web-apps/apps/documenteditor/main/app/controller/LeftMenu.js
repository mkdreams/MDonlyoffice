        ...
        clickMenuFileItem: function(menu, action, isopts) {
            ...
            switch (action) {
                ...
                case 'save-copy':
                    ...
                    break;
                case 'print':
                    this.api.asc_Print(new Asc.asc_CDownloadOptions(null, Common.Utils.isChrome || Common.Utils.isSafari || Common.Utils.isOpera));
                    break;
                case 'exit':
            ...
            if (this.mode.isEdit && !this.mode.isOffline && this.mode.canCoAuthoring) {
                ...
                switch (value) {
                    ...
                    case 'last':
                        ...
                        break;
                    default:
                        value = (fast_coauth) ? Asc.c_oAscCollaborativeMarksShowType.None : Asc.c_oAscCollaborativeMarksShowType.LastChanges;
                }
