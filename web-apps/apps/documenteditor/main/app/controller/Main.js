    ...
    DE.Controllers.Main = Backbone.Controller.extend(_.extend((function() {
        ...
        return {
            ...
            onDocumentContentReady: function() {
                ...
                application.getController('Common.Controllers.ExternalMergeEditor').setApi(this.api).loadConfig({
                    config: this.editorConfig,
                    customization: this.editorConfig.customization
                });
            ...
            applyLicense: function() {
                if (this._state.licenseType) {
                    ...
                    if (license === Asc.c_oLicenseResult.Connections || license === Asc.c_oLicenseResult.UsersCount) {
                        ...
                        buttons = [{
                            value: 'buynow',
                            caption: this.textBuyNow
                        }, {
                            value: 'contact',
                            caption: this.textContactUs
                        }];
                        primary = 'buynow';
                    }
            ...
            applyModeEditorElements: function() {
                ...
                reviewController.setMode(me.appOptions).setConfig({
                ...
                if (this.appOptions.isEdit || this.appOptions.isRestrictedEdit) { // set api events for toolbar in the Restricted Editing mode
                    ...
                    if (this.appOptions.canProtect)
                        application.getController('Common.Controllers.Protection').setMode(me.appOptions).setConfig({
                            config: me.editorConfig
                        }, me.api);
            ...
            onMeta: function(meta) {
                ...
                filemenu.loadDocument({
                    doc: this.document
                });
                filemenu.panels && filemenu.panels['info'] && filemenu.panels['info'].updateInfo(this.document);
                this.getApplication().getController('Common.Controllers.ReviewChanges').loadDocument({
                    doc: this.document
                });
