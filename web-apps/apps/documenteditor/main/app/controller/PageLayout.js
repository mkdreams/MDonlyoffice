    ...
    DE.Controllers.PageLayout = Backbone.Controller.extend((function() {
        ...
        return {
            ...
            onClickMenuForward: function(menu, item, e) {
                ...
                if (menu == 'forward')
                    props.put_ChangeLevel(Asc.c_oAscChangeLevel.BringForward);
                else
                if (menu == 'backward')
                    props.put_ChangeLevel(Asc.c_oAscChangeLevel.BringBackward);
                else
