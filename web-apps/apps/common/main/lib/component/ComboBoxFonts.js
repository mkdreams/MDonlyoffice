    ...
    Common.UI.ComboBoxFonts = Common.UI.ComboBox.extend((function() {
        ...
        return {
            ...
            render: function(parentEl) {
                ...
                this._input.on('focus', _.bind(function() {
                    this.inFormControl = true;
                }, this));
                this._input.on('blur', _.bind(function() {
                    this.inFormControl = false;
                }, this));
                ...
                this.loadSprite(function() {
                    ...
                    if (me.recent > 0) {
                        ...
                        arr.reverse().forEach(function(item) {
                            item && me.addItemToRecent(me.store.findWhere({
                                name: item
                            }), true);
                        });
                    }
