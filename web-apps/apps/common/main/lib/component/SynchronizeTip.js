        ...
        return {
            ...
            render: function() {
                if (!this.cmpEl) {
                    ...
                    this.cmpEl.find('.close').on('click', _.bind(function() {
                        this.trigger('closeclick');
                    }, this));
                    this.cmpEl.find('.show-link label').on('click', _.bind(function() {
            ...
            applyPlacement: function() {
                ...
                if (this.placement == 'top')
                    this.cmpEl.css({
                        bottom: innerHeight - showxy.top + 'px',
                        right: Common.Utils.innerWidth() - showxy.left - this.target.width() / 2 + 'px'
                    });
                else { // left or right
                    ...
                    if (this.placement == 'left')
                        this.cmpEl.css({
                            top: top + 'px',
                            right: Common.Utils.innerWidth() - showxy.left - 5 + 'px'
                        });
                    else
                        this.cmpEl.css({
                            top: top + 'px',
