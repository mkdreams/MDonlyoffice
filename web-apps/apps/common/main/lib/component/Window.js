            ...
            if (this.resizing.enabled) {
                ...
                if (this.resizing.type[0]) {
                    ...
                    if (this.resizing.type[0] < 0)
                        this.$window.css({
                            left: pageX - this.resizing.initx
                        });
        ...
        return {
            ...
            initialize: function(options) {
                ...
                var arrBtns = {
                    ...
                    yes: this.yesButtonText,
                    no: this.noButtonText,
                    ...
                    _.each(options.buttons, function(b) {
                        if (typeof(b) == 'object') {
                            if (b.value !== undefined)
                                newBtns[b.value] = {
                                    text: b.caption,
                                    cls: 'custom' + ((b.primary || options.primary == b.value) ? ' primary' : '')
                                };
                        } else {
                            newBtns[b] = {
                                text: (b == 'custom') ? options.customButtonText : arrBtns[b],
                                cls: (options.primary == b) ? 'primary' : ''
                            };
                            if (b == 'custom')
            ...
            close: function(suppressevent) {
                ...
                Common.NotificationCenter.off({
                    'window:close': this.binding.winclose
                });
