...
define([
    ...
    Common.UI.MetricSpinner = Common.UI.BaseView.extend({
        ...
        template: '<input type="text" class="form-control" spellcheck="false">' +
    ...
    Common.UI.CustomSpinner = Common.UI.MetricSpinner.extend(_.extend({
        initialize: function(options) {
            this.options.toCustomFormat = (options.toCustomFormat) ? options.toCustomFormat : function(value) {
                return value;
            };
            this.options.fromCustomFormat = (options.fromCustomFormat) ? options.fromCustomFormat : function(value) {
                return value;
            };
