...
define([
    ...
    Common.Controllers.ExternalMergeEditor = Backbone.Controller.extend(_.extend((function() {
        ...
        return {
            ...
            onLaunch: function() {
                this.mergeEditorView = this.createView('Common.Views.ExternalMergeEditor', {
            ...
            handler: function(result, value) {
                externalEditor && externalEditor.serviceCommand('queryClose', {
                    mr: result
                });
                return true;
            },
                ...
                if (this.mergeEditorView) {
                    ...
                    if (eventData.type == "processMouse") {
                        ...
                        if (eventData.data.event == 'mouse:move') {
                            ...
                            this.mergeEditorView.binding.drag({
                                pageX: x,
                                pageY: y
                            });
                        }
