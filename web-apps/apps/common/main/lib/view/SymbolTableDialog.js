...
define([
    ...
    Common.Views.SymbolTableDialog = Common.UI.Window.extend(_.extend({
        ...
        initFonts: function() {
            ...
            //initialize params
            aFontSelects = data;
            aFontSelects.sort(function(a, b) {
                return (a.displayValue.toLowerCase() > b.displayValue.toLowerCase()) ? 1 : -1;
            });
        ...
        getPasteSymbol: function(cellId) {
            ...
            return {
                font: sFont,
                symbol: this.encodeSurrogateChar(nCurrentSymbol),
                code: nCurrentSymbol,
                updateRecents: bUpdateRecents
            };
        },
                    ...
                    this.scrollerY = new Common.UI.Scroller({
                        ...
                        onChange: _.bind(function() {
                            if (this.scrollerY) {
                                ...
                                this.previewParent.css({
                                    top: this.scrollerY.getScrollTop()
                                });
                            }
                        }, this)
                    });
        ...
        onWindowResize: function(args) {
            ...
            if (args && args[1] == 'start') {
                ...
                this.symbolTablePanel.css({
                    'height': this.curSize.height + 'px'
                });
                this.previewPanel.css({
                    'height': height + 'px'
                });
                this.previewScrolled.css({
                    'height': height + 'px'
                });
                this.scrollerY = null;
