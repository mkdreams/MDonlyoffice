    ...
    Common.Views.Chat = Common.UI.BaseView.extend(_.extend({
        ...
        render: function(el) {
            ...
            $(el).html(this.template({
                scope: this,
                maxMsgLength: Asc.c_oAscMaxCellOrCommentLength
            }));
        ...
        _onResetUsers: function(c, opts) {
            if (this.panelUsers) {
                this.panelUsers.html(this.templateUserList({
                    users: this.storeUsers.chain().filter(function(item) {
        ...
        setupLayout: function() {
            var me = this,
                parent = $(me.el),
                items = this.panelBox.find(' > .layout-item');
